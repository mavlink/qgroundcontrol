...
1. Enable the `Vehicle.StandardModes` logging category.
1. Reproduce the problem: connect the vehicle (with any external modes already registered) and wait for the connection sequence to complete.
1. Back in the App Log Viewer, click **Save** to save the application log to a file.
