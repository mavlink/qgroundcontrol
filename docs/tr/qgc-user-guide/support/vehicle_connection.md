...
QGC will automatically connect to a vechile as soon as that communication link is created. Whether it be over USB, or WiFi, etc. If you establish that link and you don't see your vehicle show up in the QGC UI you can use [console logging](../settings_view/console_logging.md) to help debug the problem.
