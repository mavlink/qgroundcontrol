...
::: info
비디오 스트리밍은 [애플리케이션 설정 > 일반 탭 > 비디오](../SettingsView/General.md#video)에서 활성화하거나 설정할 수 있습니다.
:::
...
비디오 스트림 녹화는 [애플리케이션 설정 > 일반 탭](../SettingsView/General.md)에서 설정합니다.
