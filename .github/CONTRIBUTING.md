...
3. Familiarize yourself with the [Architecture](../.github/copilot-instructions.md)
...
- **Defensive coding**:
  ...
  - Validate all inputs
  - Use Q_ASSERT for development-only checks
...
- See `src/UI/preferences/CodingStyle.qml` for examples
