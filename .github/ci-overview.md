...
Independent forks retain hosted runners; upstream fork PRs use the same RunsOn pools.
Magic Cache starts before Buildx, with platform-scoped GHA v2 caches and non-PR exports.
...
Read-only native validation jobs exercise both images and build QGC on amd64.
