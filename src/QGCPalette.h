...
public:
    ...
    DEFINE_QGC_COLOR(alertBackgroundWarning,        setAlertBackgroundWarning)
    DEFINE_QGC_COLOR(alertBackgroundCaution,        setAlertBackgroundCaution)
    DEFINE_QGC_COLOR(alertBackgroundAdvisory,       setAlertBackgroundAdvisory)
    DEFINE_QGC_COLOR(alertBackgroundNormal,         setAlertBackgroundNormal)
