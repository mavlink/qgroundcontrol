 ...
 *
 * Volador Ground Control Station (VGCS) - Primary Industrial Action Button
 *
 ****************************************************************************/
...
Button {
    ...
    background: Rectangle {
        ...
        color: control.down ? Qt.darker(ThemeController.accent, 1.2) :
               (control.hovered ? Qt.lighter(ThemeController.accent, 1.1) : ThemeController.accent)
