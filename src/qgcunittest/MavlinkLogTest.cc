...
void MavlinkLogTest::_bootLogDetectionCancel_test(void)
{
    ...
    connect(this, &MavlinkLogTest::checkForLostLogFiles, qgcApp()->toolbox()->mavlinkProtocol(),
...
void MavlinkLogTest::_connectLogNoArm_test(void) { _connectLogWorker(false); }

void MavlinkLogTest::_connectLogArm_test(void) { _connectLogWorker(true); }
