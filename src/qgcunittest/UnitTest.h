...
#define UT_REGISTER_TEST_STANDALONE(className)                                                                         \
    static UnitTestWrapper<className> className(                                                                       \
        #className, true); // Test will only be run with specifically called to from command line
...
public:
    ...
    enum FileDialogType { getExistingDirectory, getOpenFileName, getOpenFileNames, getSaveFileName };
    ...
    /// Checks that the specified number of message boxes where shown. Do not call setExpectedMessageBox when using this
    /// method.
...
private:
    ...
    static QMessageBox::StandardButton _messageBox(QMessageBox::Icon icon, const QString& title, const QString& text,
    ...
    static QString _getOpenFileName(QWidget* parent, const QString& caption, const QString& dir, const QString& filter,
        QFileDialog::Options options);

    static QStringList _getOpenFileNames(QWidget* parent, const QString& caption, const QString& dir,
        const QString& filter, QFileDialog::Options options);

    static QString _getSaveFileName(QWidget* parent, const QString& caption, const QString& dir, const QString& filter,
    ...
    static bool
        _fileDialogResponseSet; ///< true: _fileDialogResponse was set by a call to UnitTest::setExpectedFileDialog
    ...
    static int
        _missedFileDialogCount; ///< Count of file dialogs not checked with call to UnitTest::fileDialogWasDisplayed
...
template <class T> class UnitTestWrapper {
public:
