...
private:
    ...
    void _stickMoveAutoStep(const char* functionStr, enum RadioComponentController::rcCalFunctions function,
        enum MoveToDirection direction, bool identifyStep);
    ...
    enum { nextButtonMask = 1 << 0, cancelButtonMask = 1 << 1, skipButtonMask = 1 << 2 };
