...
bool MultiSignalSpy::checkNoSignals(void) { return checkNoSignalByMask(~0); }
...
bool MultiSignalSpy::waitForSignalByIndex(quint32 index, ///< [in] index of signal to wait on
