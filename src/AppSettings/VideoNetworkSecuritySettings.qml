...
SettingsGroupLayout {
    ...
    property bool _usesBasicAuthentication: _settings.networkVideoAuthType.rawValue === VideoSettings.NetworkVideoAuthBasic
    ...
    LabelledFactBrowse {
        ...
        selectFolder: false
        visible: root._usesAuthentication && !ScreenTools.isMobile
    }
