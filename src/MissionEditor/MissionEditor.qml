...
This code will need to wait for Qml 5.5 support since Map.visibleRegion is only in Qt 5.5
                            ...
                            QGCButton {
                                ...
                                onClicked: {
                                    ...
                                    var region = QtPositioning.rectangle(QtPositioning.coordinate(homePositionCoordinate.latitude, homePositionCoordinate.longitude),
                                                                         QtPositioning.coordinate(homePositionCoordinate.latitude, homePositionCoordinate.longitude))
