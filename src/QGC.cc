...
void initTimer() { gBootTime = groundTimeMilliseconds(); }

quint64 bootTimeMilliseconds() { return groundTimeMilliseconds() - gBootTime; }

quint64 groundTimeUsecs() { return groundTimeMilliseconds() * 1000; }

quint64 groundTimeMilliseconds() { return static_cast<quint64>(QDateTime::currentMSecsSinceEpoch()); }

qreal groundTimeSeconds() { return static_cast<qreal>(groundTimeMilliseconds()) / 1000.0f; }
...
static const quint32 crctab[] = {0x00000000, 0x77073096, 0xee0e612c, 0x990951ba, 0x076dc419, 0x706af48f, 0xe963a535,
