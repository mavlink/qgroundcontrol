...
airmap::services::Traffic::Monitor::Monitor(
    const std::shared_ptr<Dispatcher>& dispatcher, const std::shared_ptr<airmap::Traffic::Monitor>& native)
...
void airmap::services::Traffic::Monitor::subscribe(
...
std::shared_ptr<airmap::services::Traffic> airmap::services::Traffic::create(
...
airmap::services::Traffic::Traffic(
    const std::shared_ptr<Dispatcher>& dispatcher, const std::shared_ptr<airmap::Client>& client)
    : dispatcher_ {dispatcher}
    , client_ {client}
{
