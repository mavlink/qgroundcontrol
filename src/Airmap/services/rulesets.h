...
namespace services {
    ...
    public:
        static std::shared_ptr<RuleSets> create(
        ...
        void evaluate_flight_plan(
            const EvaluateFlightPlan::Parameters& parameters, const EvaluateFlightPlan::Callback& cb) override;
