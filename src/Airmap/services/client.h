...
namespace services {
    ...
    public:
        ...
        /// 'configuration'. The result of the request is reported to 'cb', on the thread that issued the create
        /// request.
        ///
        ...
        static void create(const Client::Configuration& configuration, const std::shared_ptr<Logger>& logger,
