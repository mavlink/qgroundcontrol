...
private:
    ...
    void _handlePermissionStatus(const Qt::PermissionStatus &permissionStatus);
    ...
    static constexpr const qreal s_minHorizonalAccuracyMeters = 100.;
    static constexpr const qreal s_minVerticalAccuracyMeters = 10.;
    static constexpr const qreal s_minDirectionAccuracyDegrees = 30.;
};
