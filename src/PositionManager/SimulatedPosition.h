...
public:
    ...
    PositioningMethods supportedPositioningMethods() const final { return AllPositioningMethods; }
...
private:
    ...
    static constexpr const int s_updateIntervalMsecs = 1000;
    static constexpr const qreal s_horizontalVelocityMetersPerSec = 0.5;
    static constexpr const qreal s_verticalVelocityMetersPerSec = 0.1;
    static constexpr const qreal s_heading = 45.;
};
