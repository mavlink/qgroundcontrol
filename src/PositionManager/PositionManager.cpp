...
void QGCPositionManager::_handlePermissionStatus(const Qt::PermissionStatus &permissionStatus)
{
...
void QGCPositionManager::_setPositionSource(QGCPositionSource source)
{
    ...
    if (m_currentSource != nullptr) {
        ...
        /*_compass = new QGCCompass(this);
        connect(_compass, &QGCCompass::positionUpdated, this, &QGCPositionManager::_positionUpdated);
        (void) _compass->init();*/
