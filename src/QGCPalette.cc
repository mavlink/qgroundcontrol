...
void QGCPalette::_buildMap()
{
    ...
    DECLARE_QGC_COLOR(buttonHighlight,      "#e4e4e4", "#946120", "#3a3a3a", "#7bbb4d") // "#e4e4e4", "#946120", "#3a3a3a", "#fff291"
    ...
    //                                              Disabled    Enabled
    DECLARE_QGC_NONTHEMED_COLOR(brandingPurple,     "#00a04b", "#00a04b") // "#4A2C6D", "#4A2C6D"
    DECLARE_QGC_NONTHEMED_COLOR(brandingBlue,       "#48D6FF", "#00d04b")
