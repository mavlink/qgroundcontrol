...
void QGCPalette::_buildMap()
{
    ...
    DECLARE_QGC_COLOR(alertBackgroundWarning,  "#ed3939", "#ed3939", "#f32836", "#f32836")
    DECLARE_QGC_COLOR(alertBackgroundCaution,  "#eecc44", "#eecc44", "#eecc44", "#eecc44")
    DECLARE_QGC_COLOR(alertBackgroundAdvisory, "#ffffff", "#ffffff", "#ffffff", "#ffffff")
    DECLARE_QGC_COLOR(alertBackgroundNormal,   "#009431", "#009431", "#00e04b", "#00e04b")
