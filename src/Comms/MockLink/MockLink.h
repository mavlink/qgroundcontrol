...
public:
    ...
    static MockLink* startMockLink(MAV_AUTOPILOT mavAutopilot, MAV_TYPE mavType, bool sendStatusText, bool isSecureConnection, MockConfiguration::FailureMode_t failureMode = MockConfiguration::FailNone);
