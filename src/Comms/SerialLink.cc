    ...
    , _workerThread(new QThread(this))
{
    ...
    (void) connect(_worker, &SerialWorker::connected, this, &SerialLink::_onConnected);
    (void) connect(_worker, &SerialWorker::disconnected, this, &SerialLink::_onDisconnected);
    (void) connect(_worker, &SerialWorker::dataReceived, this, &SerialLink::_onDataReceived);
    (void) connect(_worker, &SerialWorker::dataSent, this, &SerialLink::_onDataSent);
    (void) connect(_worker, &SerialWorker::errorOccurred, this, &SerialLink::_onErrorOccurred);
