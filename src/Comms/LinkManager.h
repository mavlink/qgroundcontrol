...
private:
    ...
    static constexpr const int _autoconnectUpdateTimerMSecs =   1000;
#ifdef Q_OS_WIN
    // Have to manually let the bootloader go by on Windows to get a working connect
    static constexpr const int _autoconnectConnectDelayMSecs =  6000;
#else
    static constexpr const int _autoconnectConnectDelayMSecs =  1000;
#endif
