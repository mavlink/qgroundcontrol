    ...
    : APMFirmwarePlugin(parent)
{
    ...
    static FlightModeList availableFlightModes = {
        ...
        // Keep advanced/non-product modes mapped so reported vehicle state still has a readable name,
        // but hide them from the operator flight-mode dropdown.
        { _manualFlightMode       , APMPlaneMode::MANUAL        , false , true },
        { _circleFlightMode       , APMPlaneMode::CIRCLE        , false , true },
        { _stabilizeFlightMode    , APMPlaneMode::STABILIZE     , false , true },
        { _trainingFlightMode     , APMPlaneMode::TRAINING      , false , true },
        { _acroFlightMode         , APMPlaneMode::ACRO          , false , true },
        { _flyByWireAFlightMode   , APMPlaneMode::FLY_BY_WIRE_A , false , true },
        { _flyByWireBFlightMode   , APMPlaneMode::FLY_BY_WIRE_B , false , true },
        { _cruiseFlightMode       , APMPlaneMode::CRUISE        , false , true },
        { _autoTuneFlightMode     , APMPlaneMode::AUTOTUNE      , false , true },
        { _avoidADSBFlightMode    , APMPlaneMode::AVOID_ADSB    , false , true },
        { _initializingFlightMode , APMPlaneMode::INITIALIZING  , false , true },
        { _qStabilizeFlightMode   , APMPlaneMode::QSTABILIZE    , false , true },
        { _qHoverFlightMode       , APMPlaneMode::QHOVER        , false , true },
        { _qAutotuneFlightMode    , APMPlaneMode::QAUTOTUNE     , false , true },
        { _qAcroFlightMode        , APMPlaneMode::QACRO         , false , true },
        { _thermalFlightMode      , APMPlaneMode::THERMAL       , false , true },
        { _loiter2qlandFlightMode , APMPlaneMode::LOITER2QLAND  , false , true },
    };
