...
void ArduRoverFirmwarePlugin::guidedModeChangeAltitude(
    Vehicle* /*vehicle*/, double /*altitudeChange*/, bool /*pauseVehicle*/)
{
...
void ArduRoverFirmwarePlugin::sendGCSMotionReport(
