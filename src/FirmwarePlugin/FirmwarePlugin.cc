...
int FirmwarePlugin::defaultJoystickTXMode(void) { return 2; }
...
bool FirmwarePlugin::supportsRadio(void) { return true; }

bool FirmwarePlugin::supportsMotorInterference(void) { return true; }

bool FirmwarePlugin::supportsJSButton(void) { return false; }
...
void FirmwarePlugin::adjustOutgoingMavlinkMessageThreadSafe(
    Vehicle* /*vehicle*/, LinkInterface* /*outgoingLink*/, mavlink_message_t* /*message*/)
{
    // Generic plugin does no message adjustment
}
...
void FirmwarePlugin::guidedModeChangeGroundSpeed(Vehicle*, double)
{
    // Not supported by generic vehicle
    qgcApp()->showAppMessage(guided_mode_not_supported_by_vehicle);
}

void FirmwarePlugin::guidedModeChangeEquivalentAirspeed(Vehicle*, double)
{
    // Not supported by generic vehicle
    qgcApp()->showAppMessage(guided_mode_not_supported_by_vehicle);
}
...
int FirmwarePlugin::remapParamNameHigestMinorVersionNumber(int) const { return 0; }
...
const QVariantList& FirmwarePlugin::cameraList(const Vehicle*)
{
    if (_cameraList.size() == 0) {
        ...
        metaData = new CameraMetaData(
            ...
            tr("Canon S100 PowerShot"), // SHOULD BE BLANK FOR NEWLY ADDED CAMERAS. Deprecated translation from older
                                        // builds.
            this); // parent
        ...
        metaData = new CameraMetaData(
            ...
            "Canon EOS-M 22mm", tr("Canon"), tr("EOS-M 22mm"),
            22.3, // sensorWidth
            14.9, // sensorHeight
            5184, // imageWidth
            3456, // imageHeight
            ...
            false, // true: camera is fixed orientation
            0, // minimum trigger interval
            tr("Canon EOS-M 22mm"), // SHOULD BE BLANK FOR NEWLY ADDED CAMERAS. Deprecated translation from older
                                    // builds.
            this); // parent
        _cameraList.append(QVariant::fromValue(metaData));
        ...
        metaData = new CameraMetaData(
            ...
            "Canon G9 X PowerShot", tr("Canon"), tr("G9 X PowerShot"),
            13.2, // sensorWidth
            8.8, // sensorHeight
            5488, // imageWidth
            3680, // imageHeight
            ...
            false, // true: camera is fixed orientation
            0, // minimum trigger interval
            tr("Canon G9 X PowerShot"), // SHOULD BE BLANK FOR NEWLY ADDED CAMERAS. Deprecated translation from older
                                        // builds.
            this); // parent
        _cameraList.append(QVariant::fromValue(metaData));
        ...
        metaData = new CameraMetaData(
            ...
            "Canon SX260 HS PowerShot", tr("Canon"), tr("SX260 HS PowerShot"),
            6.17, // sensorWidth
            4.55, // sensorHeight
            4000, // imageWidth
            3000, // imageHeight
            ...
            false, // true: camera is fixed orientation
            0, // minimum trigger interval
            tr("Canon SX260 HS PowerShot"), // SHOULD BE BLANK FOR NEWLY ADDED CAMERAS. Deprecated translation from
                                            // older builds.
            this); // parent
        _cameraList.append(QVariant::fromValue(metaData));

        metaData = new CameraMetaData("GoPro Hero 4", tr("GoPro"), tr("Hero 4"),
            6.17, // sensorWidth
            4.55, // sendsorHeight
            4000, // imageWidth
            3000, // imageHeight
        ...
        metaData = new CameraMetaData("Parrot Sequioa RGB", tr("Parrot"), tr("Sequioa RGB"),
            6.17, // sensorWidth
            4.63, // sendsorHeight
            4608, // imageWidth
            3456, // imageHeight
            ...
            tr("Parrot Sequioa RGB"), // SHOULD BE BLANK FOR NEWLY ADDED CAMERAS. Deprecated translation from older
                                      // builds.
            this);
        _cameraList.append(QVariant::fromValue(metaData));

        metaData = new CameraMetaData("Parrot Sequioa Monochrome", tr("Parrot"), tr("Sequioa Monochrome"),
            4.8, // sensorWidth
            3.6, // sendsorHeight
            1280, // imageWidth
            960, // imageHeight
            ...
            tr("Parrot Sequioa Monochrome"), // SHOULD BE BLANK FOR NEWLY ADDED CAMERAS. Deprecated translation from
                                             // older builds.
            this);
        _cameraList.append(QVariant::fromValue(metaData));

        metaData = new CameraMetaData("RedEdge", tr("RedEdge"), tr("RedEdge"),
            4.8, // sensorWidth
            3.6, // sendsorHeight
            1280, // imageWidth
            960, // imageHeight
        ...
        metaData = new CameraMetaData("Sentera Double 4K Sensor", tr("Sentera"), tr("Double 4K Sensor"),
            6.2, // sensorWidth
            4.65, // sendsorHeight
            4000, // imageWidth
            3000, // imageHeight
            ...
            false, // fixedOrientation
            0.8, // minTriggerInterval
            tr("Sentera Double 4K Sensor"), // SHOULD BE BLANK FOR NEWLY ADDED CAMERAS. Deprecated translation from
                                            // older builds.
            this);
        _cameraList.append(QVariant::fromValue(metaData));

        metaData = new CameraMetaData("Sentera NDVI Single Sensor", tr("Sentera"), tr("NDVI Single Sensor"),
            4.68, // sensorWidth
            3.56, // sendsorHeight
            1248, // imageWidth
            952, // imageHeight
            ...
            tr("Sentera NDVI Single Sensor"), // SHOULD BE BLANK FOR NEWLY ADDED CAMERAS. Deprecated translation from
                                              // older builds.
            this);
        _cameraList.append(QVariant::fromValue(metaData));

        metaData = new CameraMetaData("Sentera 6X Sensor", tr("Sentera"), tr("6X Sensor"),
            6.57, // sensorWidth
            4.93, // sendsorHeight
            1904, // imageWidth
            1428, // imageHeight
        ...
        metaData = new CameraMetaData(
            ...
            "Sony a6000 16mm", tr("Sony"), tr("a6000 16mm"),
            23.5, // sensorWidth
            15.6, // sensorHeight
            6000, // imageWidth
            4000, // imageHeight
        ...
        metaData = new CameraMetaData("Sony a6000 35mm", tr("Sony"), tr("a6000 35mm"),
            23.5, // sensorWidth
            15.6, // sensorHeight
            6000, // imageWidth
            4000, // imageHeight
        ...
        metaData = new CameraMetaData("Sony a6300 Zeiss 21mm f/2.8", tr("Sony"), tr("a6300 Zeiss 21mm f/2.8"),
            23.5, // sensorWidth
            15.6, // sensorHeight
            6000, // imageWidth
            4000, // imageHeight
            ...
            false, // true: camera is fixed orientation
            1.0, // minimum trigger interval
            tr("Sony a6300 Zeiss 21mm f/2.8"), // SHOULD BE BLANK FOR NEWLY ADDED CAMERAS. Deprecated translation from
                                               // older builds.
            this); // parent
        _cameraList.append(QVariant::fromValue(metaData));

        metaData = new CameraMetaData("Sony a6300 Sony 28mm f/2.0", tr("Sony"), tr("a6300 Sony 28mm f/2.0"),
            23.5, // sensorWidth
            15.6, // sensorHeight
            6000, // imageWidth
            4000, // imageHeight
            ...
            false, // true: camera is fixed orientation
            1.0, // minimum trigger interval
            tr("Sony a6300 Sony 28mm f/2.0"), // SHOULD BE BLANK FOR NEWLY ADDED CAMERAS. Deprecated translation from
                                              // older builds.
            this); // parent
        _cameraList.append(QVariant::fromValue(metaData));

        metaData = new CameraMetaData("Sony a7R II Zeiss 21mm f/2.8", tr("Sony"), tr("a7R II Zeiss 21mm f/2.8"),
            35.814, // sensorWidth
            23.876, // sensorHeight
            7952, // imageWidth
            5304, // imageHeight
            ...
            1.0, // minimum trigger interval
            tr("Sony a7R II Zeiss 21mm f/2.8"), // SHOULD BE BLANK FOR NEWLY ADDED CAMERAS. Deprecated translation from
                                                // older builds.
            this); // parent
        _cameraList.append(QVariant::fromValue(metaData));

        metaData = new CameraMetaData("Sony a7R II Sony 28mm f/2.0", tr("Sony"), tr("a7R II Sony 28mm f/2.0"),
            35.814, // sensorWidth
            23.876, // sensorHeight
            7952, // imageWidth
            5304, // imageHeight
            ...
            true, // true: camera is fixed orientation
            1.0, // minimum trigger interval
            tr("Sony a7R II Sony 28mm f/2.0"), // SHOULD BE BLANK FOR NEWLY ADDED CAMERAS. Deprecated translation from
                                               // older builds.
            this); // parent
        _cameraList.append(QVariant::fromValue(metaData));

        metaData = new CameraMetaData("Sony a7r III 35mm", tr("Sony"), tr("a7r III 35mm"),
            35.9, // sensorWidth
            24.0, // sensorHeight
            7952, // imageWidth
            5304, // imageHeight
        ...
        metaData = new CameraMetaData("Sony a7r IV 35mm", tr("Sony"), tr("a7r IV 35mm"),
            35.7, // sensorWidth
            23.8, // sensorHeight
            9504, // imageWidth
            6336, // imageHeight
        ...
        metaData = new CameraMetaData("Sony DSC-QX30U @ 4.3mm f/3.5", tr("Sony"), tr("DSC-QX30U @ 4.3mm f/3.5"),
            7.82, // sensorWidth
            5.865, // sensorHeight
            5184, // imageWidth
            3888, // imageHeight
            ...
            tr("Sony DSC-QX30U @ 4.3mm f/3.5"), // SHOULD BE BLANK FOR NEWLY ADDED CAMERAS. Deprecated translation from
                                                // older builds.
            this); // parent
        _cameraList.append(QVariant::fromValue(metaData));

        metaData = new CameraMetaData("Sony DSC-RX0", tr("Sony"), tr("DSC-RX0"),
            13.2, // sensorWidth
            8.8, // sensorHeight
            4800, // imageWidth
            3200, // imageHeight
        ...
        metaData = new CameraMetaData("Sony DSC-RX1R II 35mm", tr("Sony"), tr("DSC-RX1R II 35mm"),
            35.9, // sensorWidth
            24.0, // sensorHeight
            7952, // imageWidth
            5304, // imageHeight
        ...
        metaData = new CameraMetaData(
            ...
            "Sony ILCE-QX1", tr("Sony"), tr("ILCE-QX1"),
            23.2, // sensorWidth
            15.4, // sensorHeight
            5456, // imageWidth
            3632, // imageHeight
        ...
        metaData = new CameraMetaData(
            ...
            "Sony NEX-5R 20mm", tr("Sony"), tr("NEX-5R 20mm"),
            23.2, // sensorWidth
            15.4, // sensorHeight
            4912, // imageWidth
            3264, // imageHeight
            ...
            tr("Sony NEX-5R 20mm"), // SHOULD BE BLANK FOR NEWLY ADDED CAMERAS. Deprecated translation from older
                                    // builds.
            this); // parent
        _cameraList.append(QVariant::fromValue(metaData));
        ...
        metaData = new CameraMetaData(
            ...
            "Sony RX100 II 28mm", tr("Sony"), tr("RX100 II 28mm"),
            13.2, // sensorWidth
            8.8, // sensorHeight
            5472, // imageWidth
            3648, // imageHeight
            ...
            false, // true: camera is fixed orientation
            0, // minimum trigger interval
            tr("Sony RX100 II 28mm"), // SHOULD BE BLANK FOR NEWLY ADDED CAMERAS. Deprecated translation from older
                                      // builds.
            this); // parent
        _cameraList.append(QVariant::fromValue(metaData));

        metaData = new CameraMetaData("Yuneec CGOET", tr("Yuneec"), tr("CGOET"),
            5.6405, // sensorWidth
            3.1813, // sensorHeight
            1920, // imageWidth
            1080, // imageHeight
        ...
        metaData = new CameraMetaData("Yuneec E10T", tr("Yuneec"), tr("E10T"),
            5.6405, // sensorWidth
            3.1813, // sensorHeight
            1920, // imageWidth
            1080, // imageHeight
        ...
        metaData = new CameraMetaData("Yuneec E50", tr("Yuneec"), tr("E50"),
            6.2372, // sensorWidth
            4.7058, // sensorHeight
            4000, // imageWidth
            3000, // imageHeight
        ...
        metaData = new CameraMetaData("Yuneec E90", tr("Yuneec"), tr("E90"),
            13.3056, // sensorWidth
            8.656, // sensorHeight
            5472, // imageWidth
            3648, // imageHeight
        ...
        metaData = new CameraMetaData("Flir Duo R", tr("Flir"), tr("Duo R"),
            160, // sensorWidth
            120, // sensorHeight
            1920, // imageWidth
            1080, // imageHeight
        ...
        metaData = new CameraMetaData("Flir Duo Pro R", tr("Flir"), tr("Duo Pro R"),
            10.88, // sensorWidth
            8.704, // sensorHeight
            640, // imageWidth
            512, // imageHeight
        ...
        metaData = new CameraMetaData("Workswell Wiris Security Thermal Camera", tr("Workswell"), tr("Wiris Security"),
            13.6, // sensorWidth
            10.2, // sensorHeight
            800, // imageWidth
            600, // imageHeight
        ...
        metaData = new CameraMetaData("Workswell Wiris Security Visual Camera", tr("Workswell"), tr("Wiris Security"),
            4.826, // sensorWidth
            3.556, // sensorHeight
            1920, // imageWidth
            1080, // imageHeight
...
void FirmwarePlugin::batteryConsumptionData(
    Vehicle* vehicle, int& mAhBattery, double& hoverAmps, double& cruiseAmps) const
{
    Q_UNUSED(vehicle);
    mAhBattery = 0;
    hoverAmps = 0;
...
QGCCameraManager* FirmwarePlugin::createCameraManager(Vehicle* vehicle) { return new QGCCameraManager(vehicle); }

QGCCameraControl* FirmwarePlugin::createCameraControl(
...
void FirmwarePlugin::_versionFileDownloadFinished(QString& remoteFile, QString& localFile, Vehicle* vehicle)
{
    ...
    if (currType == FIRMWARE_VERSION_TYPE_OFFICIAL && vehicle->versionCompare(version) < 0) {
        QString currentVersionNumber = QString("%1.%2.%3")
                                           .arg(vehicle->firmwareMajorVersion())
                                           .arg(vehicle->firmwareMinorVersion())
                                           .arg(vehicle->firmwarePatchVersion());
        qgcApp()->showAppMessage(tr("Vehicle is not running latest stable firmware! Running %1, latest stable is %2.")
...
QString FirmwarePlugin::gotoFlightMode(void) const { return QString(); }

void FirmwarePlugin::sendGCSMotionReport(
    Vehicle* vehicle, FollowMe::GCSMotionReport& motionReport, uint8_t estimationCapabilities)
{
...
Autotune* FirmwarePlugin::createAutotune(Vehicle* vehicle) { return new Autotune(vehicle); }
