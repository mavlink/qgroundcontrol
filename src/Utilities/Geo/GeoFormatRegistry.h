...
/// from various file formats using native parsers.
///
/// Supported formats:
...
namespace GeoFormatRegistry
{
    ...
    struct FormatInfo {
        ...
        bool isNative = true;     ///< True if handled by native code
    };
...
public:
    ...
    enum ShapeType {
        ...
        Track = static_cast<int>(GeoFormatRegistry::ShapeType::Track),
        Airspace = static_cast<int>(GeoFormatRegistry::ShapeType::Airspace)
    };
    Q_ENUM(ShapeType)
    ...
    enum Capability {
        ...
        CanReadAirspace = GeoFormatRegistry::CanReadAirspace,
        ...
        CanWritePolygonsWithHoles = GeoFormatRegistry::CanWritePolygonsWithHoles,
