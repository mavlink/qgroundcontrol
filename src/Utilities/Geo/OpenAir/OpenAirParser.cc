...
namespace {
    ...
    [[maybe_unused]] constexpr double kFlightLevelToMeters = 30.48; // FL1 = 100ft = 30.48m
    ...
    QList<QGeoCoordinate> generateArc(const QGeoCoordinate &center, double radiusNm,
                                       double startAngle, double endAngle, bool clockwise, [[maybe_unused]] int numPoints = 36)
    {
        QList<QGeoCoordinate> points;
        double radiusM = radiusNm * kNauticalMilesToMeters;
