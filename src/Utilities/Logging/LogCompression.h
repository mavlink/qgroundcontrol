...
///        Rejects payloads whose declared size exceeds this to prevent decompression bombs.
/// @return Original uncompressed data, or empty on error
QByteArray decompress(const QByteArray& data, qint64 maxDecompressedSize = 64LL * 1024 * 1024);
