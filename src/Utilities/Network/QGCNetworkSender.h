...
/// Uses QtConcurrent with blocking waitFor* calls which process socket events
/// internally without requiring an event loop (per Qt documentation).
...
private:
    ...
    bool _sendTcp(const QByteArray& data, Protocol protocol);
