...
private:
    ...
    static constexpr const int _calCenterPoint =       0;
    static constexpr const int _calValidMinValue =     -32768;     ///< Largest valid minimum axis value
    static constexpr const int _calValidMaxValue =     32767;      ///< Smallest valid maximum axis value
    static constexpr const int _calDefaultMinValue =   -32768;     ///< Default value for Min if not set
    static constexpr const int _calDefaultMaxValue =   32767;      ///< Default value for Max if not set
    static constexpr const int _calRoughCenterDelta =  500;        ///< Delta around center point which is considered to be roughly centered
    static constexpr const int _calMoveDelta =         32768/2;    ///< Amount of delta past center which is considered stick movement
    static constexpr const int _calSettleDelta =       600;        ///< Amount of delta which is considered no stick movement
    static constexpr const int _calMinDelta =          1000;       ///< Amount of delta allowed around min value to consider channel at min
