                             ...
                             [[maybe_unused]] HwResolvedPathCache* pathCache) noexcept
{
    ...
    // HW selection failed though GPU was requested: signal the demotion. show_frame owns the once-per-epoch
    // latch and telemetry so this mapper stays free of the telemetry singleton.
    out.demoted = hwContext.gpuEnabled;
    out.gpuPath = matchedPath;
#endif
