...
QGC_LOGGING_CATEGORY(VideoManagerLog, "VIDEOYO")
...
VideoManager::setToolbox(QGCToolbox *toolbox)
{
   ...
   connect(pVehicleMgr, &MultiVehicleManager::activeVehicleChanged, this, &VideoManager::_setActiveVehicle);
    ...
    if (_videoReceiverData[0].receiver != nullptr) {
        connect(_videoReceiverData[0].receiver, &VideoReceiver::streamingChanged, this, [this](bool active){
            _streaming = active;
            emit streamingChanged();
        });

        connect(_videoReceiverData[0].receiver, &VideoReceiver::onStartComplete, this, [this](VideoReceiver::STATUS status) {
        ...
        connect(_videoReceiverData[0].receiver, &VideoReceiver::onStopComplete, this, [this](VideoReceiver::STATUS status) {
        ...
        connect(_videoReceiverData[0].receiver, &VideoReceiver::decodingChanged, this, [this](bool active){
            qCDebug(VideoManagerLog) << "Video 0 decoding changed, active: " << (active ? "yes" : "no");
            _decoding = active;
            emit decodingChanged();
        });

        connect(_videoReceiverData[0].receiver, &VideoReceiver::recordingChanged, this, [this](bool active){
        ...
        connect(_videoReceiverData[0].receiver, &VideoReceiver::recordingStarted, this, [this](){
            qCDebug(VideoManagerLog) << "Video 0 recording started";
            _subtitleWriter->startCapturingTelemetry(_videoFile);
        });

        connect(_videoReceiverData[0].receiver, &VideoReceiver::videoSizeChanged, this, [this](QSize size){
        ...
        connect(_videoReceiverData[0].receiver, &VideoReceiver::onTakeScreenshotComplete, this, [this](VideoReceiver::STATUS status){
            if (status == VideoReceiver::STATUS_OK) {
    ...
    if (_videoReceiverData[1].receiver != nullptr) {
        connect(_videoReceiverData[1].receiver, &VideoReceiver::onStartComplete, this, [this](VideoReceiver::STATUS status) {
            if (status == VideoReceiver::STATUS_OK) {
        ...
        connect(_videoReceiverData[1].receiver, &VideoReceiver::onStopComplete, this, [this](VideoReceiver::STATUS) {
