...
/// \brief This class is used to encapsulate the QGeoCoordinate associated with a Rally Point into a QObject
/// such that it can be used in a QmlObjectListModel for QML.
