...
public:
    ...
    Q_PROPERTY(Vehicle* managerVehicle READ managerVehicle NOTIFY
            managerVehicleChanged) ///< Either active vehicle or _controllerVehicle if no active vehicle
    ...
    Q_PROPERTY(
        bool offline READ offline NOTIFY offlineChanged) ///< true: controller is not connected to an active vehicle
    Q_PROPERTY(bool containsItems READ containsItems NOTIFY containsItemsChanged) ///< true: Elemement is non-empty
    Q_PROPERTY(bool syncInProgress READ syncInProgress NOTIFY
            syncInProgressChanged) ///< true: Information is currently being saved/sent, false: no active save/send in
                                   ///< progress
    Q_PROPERTY(bool dirty READ dirty WRITE setDirty NOTIFY
            dirtyChanged) ///< true: Unsaved/sent changes are present, false: no changes since last save/send
    ...
    ///     @param deleteWhenSendCmplete The PlanMasterController object should be deleted after the first send is
    ///     completed.
