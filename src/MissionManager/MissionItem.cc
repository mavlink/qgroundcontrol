...
MissionItem::MissionItem(QObject* parent)
    ...
    , _commandFact                  (0, QLatin1String(""),                             FactMetaData::valueTypeUint32)
    , _frameFact                    (0, QLatin1String(""),                             FactMetaData::valueTypeUint32)
...
void MissionItem::save(QTextStream &saveStream)
{
    ...
    saveStream << sequenceNumber() << "\t"
               ...
               << frame() << "\t"
               << command() << "\t"
               << QStringLiteral("%1").arg(param1(), 0, 'g', 18) << "\t"
               << QStringLiteral("%1").arg(param2(), 0, 'g', 18) << "\t"
               << QStringLiteral("%1").arg(param3(), 0, 'g', 18) << "\t"
               << QStringLiteral("%1").arg(param4(), 0, 'g', 18) << "\t"
               << QStringLiteral("%1").arg(param5(), 0, 'g', 18) << "\t"
               << QStringLiteral("%1").arg(param6(), 0, 'g', 18) << "\t"
               << QStringLiteral("%1").arg(param7(), 0, 'g', 18) << "\t"
               << this->autoContinue() << "\r\n";
}
