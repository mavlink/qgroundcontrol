...
class GeoFenceController : public PlanElementController
{
   ...
   public:
    ...
    // Radius of the "paramCircularFence" which is called the "Geofence Failsafe" in PX4 and the "Circular Geofence" on
    // ArduPilot
    ...
    {
        return &_breachReturnAltitudeFact;
    }
