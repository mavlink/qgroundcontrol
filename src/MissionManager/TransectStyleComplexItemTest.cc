...
void TransectStyleComplexItemTest::_testFollowTerrain(void)
{
    ...
    QVERIFY(QTest::qWaitFor(
        [&]() { return _transectStyleItem->readyForSaveState() == TransectStyleComplexItem::ReadyForSave; }, 2000));
...
void TestTransectStyleItem::_recalcCameraShots(void) { recalcCameraShotsCalled = true; }
