        ...
        Component {
            ...
            QGCVideoBackground {
                ...
                Item {
                    ...
                    property real thirdW: width / 3
                    property real thirdH: height / 3
                    property color lineColor: Qt.rgba(1, 1, 1, 0.5)
                    ...
                    Rectangle {
                        ...
                        x:      gridOverlay.thirdW
                        width:  1
                        color:  gridOverlay.lineColor
                    }
