...
Column {
    ...
    Component {
        ...
        AirspaceControl {
            ...
            width:              parent.width
            planView:           false
            visible:            QGroundControl.airmapSupported && QGroundControl.settingsManager.airMapSettings.enableAirMap.rawValue
        }
    }
    ...
    Loader {
        ...
        Component.onCompleted: airspaceControlLoader.active = QGroundControl.airmapSupported
    }
