...
Item {
    ...
    readonly property string dropTitle:                     qsTr("Gripper Function")
    ...
    readonly property string dropMessage:                       qsTr("Grab or Release the cargo")
    ...
    readonly property int actionDrop:                       27
    ...
    function confirmAction(actionCode, actionData, mapIndicator) {
        ...
        case actionDrop:
            confirmDialog.hideTrigger = true
            confirmDialog.title = dropTitle
            confirmDialog.message = dropMessage
