...
QGCView {
    ...
    property bool _mainIsMap:           QGroundControl.videoManager.hasVideo ? QGroundControl.loadBoolGlobalSetting(_mainIsMapKey,  QGroundControl.isMinimalist ? false : true) : true
