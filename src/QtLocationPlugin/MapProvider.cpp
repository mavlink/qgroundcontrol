...
MapProvider::MapProvider(const QString& referrer, const QString& imageFormat, const quint32 averageSize,
...
int MapProvider::_getServerNum(const int x, const int y, const int max) const { return (x + 2 * y) % max; }
...
QGCTileSet MapProvider::getTileCount(const int zoom, const double topleftLon, const double topleftLat,
