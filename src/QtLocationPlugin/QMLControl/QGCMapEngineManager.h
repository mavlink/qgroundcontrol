...
public:
    ...
    Q_INVOKABLE void updateForCurrentView(
    ...
    void setImportReplace(bool replace)
    {
        _importReplace = replace;
        emit importReplaceChanged();
    }
    ...
    void setFetchElevation(bool fetchElevation)
    {
        _fetchElevation = fetchElevation;
        emit fetchElevationChanged();
    }
