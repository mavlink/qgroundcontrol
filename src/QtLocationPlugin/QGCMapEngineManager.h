...
/// @file
/// @brief Map tile cache management and download coordination
///
/// The QGCMapEngineManager is the main coordinator for offline map tile
/// functionality. It manages:
/// - Creation and deletion of tile sets
/// - Download queue coordination across multiple tile sets
/// - Cache size limits and pruning
/// - Import/export of tile databases
/// - Integration with the worker thread for database operations
///
/// Thread Safety:
/// - This class lives on the main/UI thread
/// - Database operations are delegated to QGCCacheWorker (worker thread)
/// - Uses Qt's queued connections for cross-thread communication
///
