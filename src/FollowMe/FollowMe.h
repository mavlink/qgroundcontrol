...
public:
    ...
    struct GCSMotionReport {
        ...
        double altMetersAMSL; //	Altitude in meters in AMSL altitude, not WGS84 if absolute or relative, above
    ...
    enum { POS = 0, VEL = 1, ACCEL = 2, ATT_RATES = 3, HEADING = 4 };
...
private:
    enum { MODE_NEVER, MODE_ALWAYS, MODE_FOLLOWME };
