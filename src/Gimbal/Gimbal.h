...
private:
    ...
    /// Q_PROPERTIES
    Fact *_absoluteRollFact = nullptr;
    Fact *_absolutePitchFact = nullptr;
    Fact *_bodyYawFact = nullptr;
    Fact *_absoluteYawFact = nullptr;
    Fact *_deviceIdFact = nullptr; ///< Component ID of gimbal device (or 1-6 for non-MAVLink gimbal)
    Fact *_managerCompidFact = nullptr;
