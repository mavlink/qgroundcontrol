...
Gimbal::Gimbal(GimbalController *parent)
    : FactGroup(100, QStringLiteral(":/json/Vehicle/GimbalFact.json"), parent)
{
...
Gimbal::Gimbal(const Gimbal &other)
    : FactGroup(100, ":/json/Vehicle/GimbalFact.json", other.parent())
{
    // qCDebug(GimbalLog) << Q_FUNC_INFO << this;
...
{
    _absoluteRollFact = new Fact(0, _absoluteRollFactName, FactMetaData::valueTypeFloat, this);
    _absolutePitchFact = new Fact(0, _absolutePitchFactName, FactMetaData::valueTypeFloat, this);
    _bodyYawFact = new Fact(0, _bodyYawFactName, FactMetaData::valueTypeFloat, this);
    _absoluteYawFact = new Fact(0, _absoluteYawFactName, FactMetaData::valueTypeFloat, this);
    _deviceIdFact = new Fact(0, _deviceIdFactName, FactMetaData::valueTypeUint8, this);
    _managerCompidFact = new Fact(0, _managerCompidFactName, FactMetaData::valueTypeUint8, this);
