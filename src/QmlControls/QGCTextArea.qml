...
TextArea {
    id:                 control
    color:              qgcPal.textAreaText
    selectionColor:     qgcPal.textAreaText
    selectedTextColor:  qgcPal.textArea
    ...
    background: Rectangle {
        ...
        color:          qgcPal.textArea
        implicitWidth:  ScreenTools.implicitTextAreaWidth
        implicitHeight: ScreenTools.implicitTextAreaHeight
