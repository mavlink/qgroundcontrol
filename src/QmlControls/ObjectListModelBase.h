...
/// \brief Base class for flat QObject* list models.
///
/// Inherits common dirty/reset/role handling from ObjectItemModelBase and adds
/// flat-list index()/parent() overrides.
