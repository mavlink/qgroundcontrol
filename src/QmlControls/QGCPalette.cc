...
void QGCPalette::_buildMap()
{
    ...
    DECLARE_QGC_COLOR(window,               "#ffffff", "#ffffff", "#14171a", "#14171a")
    DECLARE_QGC_COLOR(windowShadeLight,     "#909090", "#828282", "#2c313a", "#2c313a")
    DECLARE_QGC_COLOR(windowShade,          "#d9d9d9", "#d9d9d9", "#22262c", "#22262c")
    DECLARE_QGC_COLOR(windowShadeDark,      "#bdbdbd", "#bdbdbd", "#191c20", "#191c20")
    DECLARE_QGC_COLOR(text,                 "#9d9d9d", "#000000", "#788290", "#ffffff")
    DECLARE_QGC_COLOR(warningText,          "#cc0808", "#cc0808", "#f85761", "#f85761")
    DECLARE_QGC_COLOR(button,               "#ffffff", "#ffffff", "#404652", "#242830")
    DECLARE_QGC_COLOR(buttonBorder,         "#ffffff", "#d9d9d9", "#383e4b", "#383e4b")
    DECLARE_QGC_COLOR(buttonText,           "#9d9d9d", "#000000", "#8b949e", "#ffffff")
    DECLARE_QGC_COLOR(buttonHighlight,      "#e4e4e4", "#007acc", "#3a3a3a", "#007acc")
    DECLARE_QGC_COLOR(buttonHighlightText,  "#2c2c2c", "#ffffff", "#e1e4e8", "#ffffff")
    DECLARE_QGC_COLOR(primaryButton,        "#585858", "#0066cc", "#3a4454", "#0066cc")
    DECLARE_QGC_COLOR(primaryButtonText,    "#2c2c2c", "#ffffff", "#8b949e", "#ffffff")
    DECLARE_QGC_COLOR(textField,            "#ffffff", "#ffffff", "#2a2e36", "#ffffff")
    DECLARE_QGC_COLOR(textFieldText,        "#808080", "#000000", "#8b949e", "#000000")
    DECLARE_QGC_COLOR(mapButton,            "#585858", "#000000", "#585858", "#000000")
    DECLARE_QGC_COLOR(mapButtonHighlight,   "#585858", "#007acc", "#585858", "#007acc")
    DECLARE_QGC_COLOR(mapIndicator,         "#585858", "#007acc", "#585858", "#007acc")
    DECLARE_QGC_COLOR(mapIndicatorChild,    "#585858", "#005599", "#585858", "#005599")
    ...
    DECLARE_QGC_COLOR(colorBlue,            "#007acc", "#007acc", "#0a84ff", "#0a84ff")
    ...
    DECLARE_QGC_COLOR(missionItemEditor,    "#585858", "#007acc", "#3a4454", "#1a2a3a")
    DECLARE_QGC_COLOR(toolStripHoverColor,  "#585858", "#9D9D9D", "#3a4454", "#1a2a3a")
    ...
    DECLARE_QGC_COLOR(toolbarBackground,    "#ffffff", "#ffffff", "#1a1d22", "#1a1d22")
    DECLARE_QGC_COLOR(groupBorder,          "#bbbbbb", "#bbbbbb", "#383e4b", "#383e4b")

    // Colors not affecting by theming
    //                                              Disabled    Enabled
    DECLARE_QGC_NONTHEMED_COLOR(brandingPurple,     "#1A2332", "#1A2332")
    DECLARE_QGC_NONTHEMED_COLOR(brandingBlue,       "#0099FF", "#0099FF")
