...
void QGCPalette::_buildMap()
{
    ...
    DECLARE_QGC_COLOR(window,               "#ffffff", "#ffffff", "#121417", "#121417")
    ...
    DECLARE_QGC_COLOR(textField,            "#ffffff", "#ffffff", "#181b20", "#ffffff")
    ...
    DECLARE_QGC_COLOR(mapIndicatorChild,    "#585858", "#CC5500", "#585858", "#CC5500")
    ...
    DECLARE_QGC_COLOR(toolStripHoverColor,  "#585858", "#9D9D9D", "#282d37", "#1f232b")
    ...
    DECLARE_QGC_COLOR(groupBorder,          "#bbbbbb", "#bbbbbb", "#282d37", "#282d37")
