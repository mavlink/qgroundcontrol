...
void QGCPalette::_buildMap()
{
    ...
    DECLARE_QGC_COLOR(colorGreen,           "#005c1f", "#005c1f", "#00e04b", "#00e04b") 
    DECLARE_QGC_COLOR(colorYellow,          "#6c6c00", "#6c6c00", "#ffff00", "#ffff00")  
    DECLARE_QGC_COLOR(colorYellowGreen,     "#4a6b2d", "#4a6b2d", "#9acd32", "#9acd32")  
    DECLARE_QGC_COLOR(colorOrange,          "#b04818", "#b04818", "#de8500", "#de8500")  
    DECLARE_QGC_COLOR(colorRed,             "#c81010", "#c81010", "#f32836", "#f32836")
