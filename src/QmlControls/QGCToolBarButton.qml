...
Button {
    ...
    background: Rectangle {
        anchors.fill: parent
        color:  logo ? qgcPal.brandingPurple : (checked ? qgcPal.windowShade : Qt.rgba(0,0,0,0))
    }
    ...
    contentItem: Row {
        ...
        QGCColoredImage {
            ...
            color:                  logo ? qgcPal.buttonText : (button.checked ? qgcPal.transparent : qgcPal.buttonText)
