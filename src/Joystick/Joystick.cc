...
void Joystick::_buildActionList(Vehicle *activeVehicle)
{
    ...
    (void) _assignableButtonActions->append(new AssignableButtonAction(_buttonActionGimbalDown));
    (void) _assignableButtonActions->append(new AssignableButtonAction(_buttonActionGimbalUp));
    (void) _assignableButtonActions->append(new AssignableButtonAction(_buttonActionGimbalLeft));
    (void) _assignableButtonActions->append(new AssignableButtonAction(_buttonActionGimbalRight));
