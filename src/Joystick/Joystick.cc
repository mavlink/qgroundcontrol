...
Joystick::Joystick(const QString &name, int axisCount, int buttonCount, int hatCount, QObject *parent)
    ...
    , _customActionManager(new CustomActionManager(qgcApp()->toolbox()->settingsManager()->customMavlinkActionsSettings()->joystickActionsFile(), this))
    , _assignableButtonActions(new QmlObjectListModel(this))
{
    ...
    for (int i = 0; i < _totalButtonCount; i++) {
        ...
        (void) _buttonActionArray.append(nullptr);
    }

    MultiVehicleManager *const multiVehicleManager = qgcApp()->toolbox()->multiVehicleManager();
    _buildActionList(multiVehicleManager->activeVehicle());
    _updateTXModeSettingsKey(multiVehicleManager->activeVehicle());

    _loadSettings();

    (void) connect(multiVehicleManager, &MultiVehicleManager::activeVehicleChanged, this, &Joystick::_activeVehicleChanged);
    (void) connect(multiVehicleManager->vehicles(), &QmlObjectListModel::countChanged, this, &Joystick::_vehicleCountChanged);
}
...
void Joystick::_loadSettings()
{
    ...
    Vehicle *const activeVehicle = qgcApp()->toolbox()->multiVehicleManager()->activeVehicle();
...
void Joystick::startPolling(Vehicle* vehicle)
{
    if (vehicle) {
        if (_activeVehicle) {
            ...
            (void) disconnect(this, &Joystick::gimbalPitchStep, _activeVehicle->gimbalController(), &GimbalController::gimbalPitchStep);
        ...
        if (vehicle->joystickEnabled()) {
            ...
            (void) connect(this, &Joystick::gimbalPitchStep, _activeVehicle->gimbalController(), &GimbalController::gimbalPitchStep);
            (void) connect(this, &Joystick::gimbalYawStep, _activeVehicle->gimbalController(), &GimbalController::gimbalYawStep);
...
void Joystick::setCalibrationMode(bool calibrating)
{
    ...
    if (calibrating && !isRunning()) {
        ...
        startPolling(qgcApp()->toolbox()->multiVehicleManager()->activeVehicle());
...
void Joystick::_buildActionList(Vehicle *activeVehicle)
{
    ...
    (void) _assignableButtonActions->append(new AssignableButtonAction(_buttonActionNone));
    (void) _assignableButtonActions->append(new AssignableButtonAction(_buttonActionArm));
    (void) _assignableButtonActions->append(new AssignableButtonAction(_buttonActionDisarm));
    (void) _assignableButtonActions->append(new AssignableButtonAction(_buttonActionToggleArm));
    if (activeVehicle) {
        const QStringList list = activeVehicle->flightModes();
        for (const QString &mode : list) {
            (void) _assignableButtonActions->append(new AssignableButtonAction(mode));
        }
    }
    (void) _assignableButtonActions->append(new AssignableButtonAction(_buttonActionVTOLFixedWing));
    (void) _assignableButtonActions->append(new AssignableButtonAction(_buttonActionVTOLMultiRotor));
    (void) _assignableButtonActions->append(new AssignableButtonAction(_buttonActionContinuousZoomIn, true));
    (void) _assignableButtonActions->append(new AssignableButtonAction(_buttonActionContinuousZoomOut, true));
    (void) _assignableButtonActions->append(new AssignableButtonAction(_buttonActionStepZoomIn, true));
    (void) _assignableButtonActions->append(new AssignableButtonAction(_buttonActionStepZoomOut, true));
    (void) _assignableButtonActions->append(new AssignableButtonAction(_buttonActionNextStream));
    (void) _assignableButtonActions->append(new AssignableButtonAction(_buttonActionPreviousStream));
    (void) _assignableButtonActions->append(new AssignableButtonAction(_buttonActionNextCamera));
    (void) _assignableButtonActions->append(new AssignableButtonAction(_buttonActionPreviousCamera));
    (void) _assignableButtonActions->append(new AssignableButtonAction(_buttonActionTriggerCamera));
    (void) _assignableButtonActions->append(new AssignableButtonAction(_buttonActionStartVideoRecord));
    (void) _assignableButtonActions->append(new AssignableButtonAction(_buttonActionStopVideoRecord));
    (void) _assignableButtonActions->append(new AssignableButtonAction(_buttonActionToggleVideoRecord));
    (void) _assignableButtonActions->append(new AssignableButtonAction(_buttonActionGimbalDown, true));
    (void) _assignableButtonActions->append(new AssignableButtonAction(_buttonActionGimbalUp, true));
    (void) _assignableButtonActions->append(new AssignableButtonAction(_buttonActionGimbalLeft, true));
    (void) _assignableButtonActions->append(new AssignableButtonAction(_buttonActionGimbalRight, true));
    (void) _assignableButtonActions->append(new AssignableButtonAction(_buttonActionGimbalCenter));
    (void) _assignableButtonActions->append(new AssignableButtonAction(_buttonActionGimbalYawLock));
    ...
    (void) _assignableButtonActions->append(new AssignableButtonAction(_buttonActionGripperGrab));
    (void) _assignableButtonActions->append(new AssignableButtonAction(_buttonActionGripperRelease));
    (void) _assignableButtonActions->append(new AssignableButtonAction(_buttonActionLandingGearDeploy));
    (void) _assignableButtonActions->append(new AssignableButtonAction(_buttonActionLandingGearRetract));

    for (int i = 0; i < _customActionManager->actions()->count(); i++) {
        const CustomAction *const customAction = _customActionManager->actions()->value<const CustomAction*>(i);
        (void) _assignableButtonActions->append(new AssignableButtonAction(customAction->label()));
    }
