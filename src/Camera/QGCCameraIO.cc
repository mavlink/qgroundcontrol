...
QGCCameraParamIO::_sendParameter()
{
    ...
    if (!weakLink.expired()) {
        ...
        case FactMetaData::valueTypeCustom:
        {
            ...
            p.param_type = MAV_PARAM_EXT_TYPE_CUSTOM;
        }
            break;
        default:
