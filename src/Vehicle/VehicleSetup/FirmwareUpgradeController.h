...
public:
    ...
    QString px4DevVersion(void) { return _px4DevVersion; }

    bool px4ManifestLoaded(void) { return _px4ManifestLoaded; }

    QStringList px4AvailableVersions(void) { return _px4AvailableVersions; }

    QStringList px4AdvancedVersions(void) { return _px4AdvancedVersions; }

    int px4AdvancedVersionsBestIndex(void) { return _px4AdvancedVersionsBestIndex; }
...
private slots:
    ...
    void _px4ManifestDownloadComplete(bool success, const QString& localFile, const QString& errorMsg);
