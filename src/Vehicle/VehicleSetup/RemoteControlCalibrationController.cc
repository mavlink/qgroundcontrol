...
{
    static const QMap<StateMachineStepFunction, QString> stepFunctionToMsgStringThrottleCenteredMap = {
        { StateMachineStepStickNeutral,    msgBeginThrottleCenter },
    ...
    static const QMap<StateMachineStepFunction, QString> stepFunctionToMsgStringThrottleDownMap = {
        { StateMachineStepStickNeutral,    msgBeginThrottleDown },
        { StateMachineStepThrottleUp,      msgThrottleUp },
        { StateMachineStepThrottleDown,    msgThrottleDown },
        { StateMachineStepYawRight,        msgYawRight },
        { StateMachineStepYawLeft,         msgYawLeft },
    ...
    static const QMap<StateMachineStepFunction, QMap<int, BothSticksDisplayPositions>> bothStickDisplayPositionThrottleCenteredMap = {
    ...
    static const QMap<StateMachineStepFunction, QMap<int, BothSticksDisplayPositions>> bothStickDisplayPositionThrottleDownMap = {
        { StateMachineStepStickNeutral, {
            { 1, { _stickDisplayPositionCentered,       _stickDisplayPositionXCenteredYDown } },
            { 2, { _stickDisplayPositionXCenteredYDown, _stickDisplayPositionCentered } },
            { 3, { _stickDisplayPositionCentered,       _stickDisplayPositionXCenteredYDown } },
    ...
    QString instructions = _centeredThrottle ? stepFunctionToMsgStringThrottleCenteredMap.value(state.stepFunction, QString()) :
                                                   stepFunctionToMsgStringThrottleDownMap.value(state.stepFunction, QString());
    BothSticksDisplayPositions bothStickPositions = _centeredThrottle ? bothStickDisplayPositionThrottleCenteredMap[state.stepFunction][_transmitterMode] :
                                                                            bothStickDisplayPositionThrottleDownMap[state.stepFunction][_transmitterMode];
