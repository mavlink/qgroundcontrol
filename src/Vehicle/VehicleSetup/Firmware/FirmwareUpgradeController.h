...
class FirmwareUpgradeController : public QObject
{
    ...
    friend class FirmwareUpgradeStateMachine;
    friend class FirmwareUpgradeStateMachineTest;
    friend class MockFirmwareUpgradeController;

protected:
    FirmwareUpgradeStateMachine* _getStateMachine() const { return _stateMachine; }
