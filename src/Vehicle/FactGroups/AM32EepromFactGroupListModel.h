...
public:
    static constexpr uint8_t kAM32EepromSize = 48;
...
public:
    ...
    const AM32Setting* getSetting(const QString& name) const;
    ...
    Q_INVOKABLE bool settingsMatch(const AM32EepromFactGroup* other) const;
