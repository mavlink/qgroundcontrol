...
public:
    ...
    Q_PROPERTY(bool communicationLostEnabled READ communicationLostEnabled WRITE setCommunicationLostEnabled NOTIFY
...
private:
    ...
    bool _autoDisconnect
        = false; ///< true: Automatically disconnect vehicle when last connection goes away or lost heartbeat
