...
class Vehicle : public VehicleFactGroup
{
   ...
   public:
    ...
    Q_PROPERTY(bool guidedModeSupported READ guidedModeSupported
                   CONSTANT)           ///< Guided mode commands are supported by this vehicle
    ...
    {
        return _multirotor_speed_limits_available;
    }
    bool haveFWSpeedLimits() const
    {
        return _fixed_wing_airspeed_limits_available;
    }
    ...
    {
        return QGCMAVLink::vehicleClass(_vehicleType);
    }
    ...
    {
        return _autopilotPlugin;
    }

    /// Provides access to the Firmware Plugin for this Vehicle
    FirmwarePlugin* firmwarePlugin()
    {
        return _firmwarePlugin;
    }
    ...
    {
        return !px4Firmware() && !apmFirmware();
    }
    ...
    {
        return static_cast<int>(_onboardControlSensorsPresent);
    }
    int sensorsEnabledBits() const
    {
        return static_cast<int>(_onboardControlSensorsEnabled);
    }
    int sensorsHealthBits() const
    {
        return static_cast<int>(_onboardControlSensorsHealth);
    }
    int sensorsUnhealthyBits() const
    {
        return static_cast<int>(_onboardControlSensorsUnhealthy);
    }
    ...
    {
        return &_orbitMapCircle;
    }
    bool readyToFlyAvailable() const
    {
        return _readyToFlyAvailable;
    }
    ...
    {
        return _allSensorsHealthy;
    }
    QObject* sysStatusSensorInfo()
    {
        return &_sysStatusSensorInfo;
    }
    bool requiresGpsFix() const
    {
        return static_cast<bool>(_onboardControlSensorsPresent & QGCMAVLink::SysStatusSensorGPS);
    }
    bool hilMode() const
    {
    ...
    {
        return _componentInformationManager;
    }
    VehicleObjectAvoidance* objectAvoidance()
    {
        return _objectAvoidance;
    }
    ...
    typedef enum
    {
        ...
        MavCmdResultFailureDuplicateCommand,  ///< Unable to send command since duplicate is already being waited on for
                                              ///< response
    ...
    ///     @param ack                  Received COMMAND_ACK
    ///     @param failureCode          Failure reason. If not MavCmdResultCommandResultOnly only ack.result ==
    ///     MAV_RESULT_FAILED is valid.
    typedef void (*MavCmdResultHandler)(void* resultHandlerData, int compId, const mavlink_command_ack_t& ack,
    ...
    typedef enum
    {
        ...
        RequestMessageFailureDuplicateCommand,  ///< Unabled to send command since another request message isduplicate
                                                ///< is already being waited on for response
    ...
    typedef void (*RequestMessageResultHandler)(void* resultHandlerData, MAV_RESULT commandResult,
    ...
    {
        return _firmwareMajorVersion;
    }
    int firmwareMinorVersion() const
    {
        return _firmwareMinorVersion;
    }
    int firmwarePatchVersion() const
    {
        return _firmwarePatchVersion;
    }
    int firmwareVersionType() const
    {
        return _firmwareVersionType;
    }
    int firmwareCustomMajorVersion() const
    {
        return _firmwareCustomMajorVersion;
    }
    int firmwareCustomMinorVersion() const
    {
        return _firmwareCustomMinorVersion;
    }
    int firmwareCustomPatchVersion() const
    {
        return _firmwareCustomPatchVersion;
    }
    int firmwareBoardVendorId() const
    {
        return _firmwareBoardVendorId;
    }
    int firmwareBoardProductId() const
    {
        return _firmwareBoardProductId;
    }
    ...
    {
        return _soloFirmware;
    }
    void setSoloFirmware(bool soloFirmware);

    int defaultComponentId() const
    {
        return _defaultComponentId;
    }
    ...
    {
        return _firmwarePluginInstanceData;
    }
    ...
    {
        return _capabilityBitsKnown;
    }
    uint64_t capabilityBits() const
    {
        return _capabilityBits;
    ...
    {
        return _initialPlanRequestComplete;
    }
    ...
    {
        return &_healthAndArmingCheckReport;
    }
   ...
   signals:
    ...
    void calibrationEventReceived(int uasid, int componentid, int severity,
   ...
   private:
    ...
    typedef void (*WaitForMavlinkMessageResultHandler)(void* resultHandlerData, bool noResponsefromVehicle,
                                                       const mavlink_message_t& message);
    ...
    typedef struct RequestMessageInfo
    {
        ...
        bool messageReceived = false;     // We only delete the allocated RequestMessageInfo_t when both happen (or the
    ...
    QMap<int /* compId */, QMap<int /* msgId */, RequestMessageInfo_t*>>
        _requestMessageInfoMap;  // Map of all request message calls currently waiting on a response

    void _removeRequestMessageInfo(int compId, int msgId);

    static void _requestMessageCmdResultHandler(void* resultHandlerData, int compId, const mavlink_command_ack_t& ack,
                                                MavCmdResultFailureCode_t failureCode);
    static void _requestMessageWaitForMessageResultHandler(void* resultHandlerData, bool noResponsefromVehicle,
                                                           const mavlink_message_t& message);
    ...
    void _sendMavCommandWorker(bool commandInt, bool showError,
                               const MavCmdAckHandlerInfo_t* ackHandlerInfo,  ///> nullptr to signale no handlers
                               int compId, MAV_CMD command, MAV_FRAME frame, float param1, float param2, float param3,
   ...
   private:
    ...
    static void _requestMessageMessageIntervalResultHandler(void* resultHandlerData, MAV_RESULT result,
                                                            RequestMessageResultHandlerFailureCode_t failureCode,
                                                            const mavlink_message_t& message);
    void _requestMessageInterval(uint8_t compId, uint16_t msgId);

    static void _setMessageRateCommandResultHandler(void* resultHandlerData, int compId,
   ...
   private:
    ...
    uint8_t sysidInControl() const
    {
        return _sysid_in_control;
    }
    bool gcsControlStatusFlags_SystemManager() const
    {
        return _gcsControlStatusFlags_SystemManager;
    }
    bool gcsControlStatusFlags_TakeoverAllowed() const
    {
        return _gcsControlStatusFlags_TakeoverAllowed;
    }
    bool firstControlStatusReceived() const
    {
        return _firstControlStatusReceived;
    }
    int operatorControlTakeoverTimeoutMsecs() const;
    int requestOperatorControlRemainingMsecs() const
    {
        return _timerRequestOperatorControl.remainingTime();
    }
    bool sendControlRequestAllowed() const
    {
