...
public:
    ...
    Vehicle(MAV_AUTOPILOT firmwareType, MAV_TYPE vehicleType, FirmwarePluginManager* firmwarePluginManager,
    ...
    Q_INVOKABLE void sendParamMapRC(
    ...
    typedef enum { MessageNone, MessageNormal, MessageWarning, MessageError } MessageType_t;
    ...
    Q_INVOKABLE void sendCommand(int compId, int command, bool showError, double param1 = 0.0, double param2 = 0.0,
        double param3 = 0.0, double param4 = 0.0, double param5 = 0.0, double param6 = 0.0, double param7 = 0.0);
    ...
    typedef void (*MavCmdResultHandler)(void* resultHandlerData, int compId, MAV_RESULT commandResult, uint8_t progress,
    ...
    void sendMavCommandWithHandler(MavCmdResultHandler resultHandler, void* resultHandlerData, int compId,
        MAV_CMD command, float param1 = 0.0f, float param2 = 0.0f, float param3 = 0.0f, float param4 = 0.0f,
    ...
    typedef enum {
        ...
        RequestMessageFailureDuplicateCommand, ///< Unabled to send command since duplicate is already being waited on
                                               ///< for response
...
signals:
    ...
    void calibrationEventReceived(
        int uasid, int componentid, int severity, QSharedPointer<events::parser::ParsedEvent> event);
...
private:
    ...
    static void _rebootCommandResultHandler(void* resultHandlerData, int compId, MAV_RESULT commandResult,
    ...
    typedef void (*WaitForMavlinkMessageResultHandler)(
    ...
    static void _requestMessageCmdResultHandler(void* resultHandlerData, int compId, MAV_RESULT result,
        uint8_t progress, MavCmdResultFailureCode_t failureCode);
    static void _requestMessageWaitForMessageResultHandler(
        void* resultHandlerData, bool noResponsefromVehicle, const mavlink_message_t& message);
    ...
    void _sendMavCommandWorker(bool commandInt, bool showError, MavCmdResultHandler resultHandler,
        void* resultHandlerData, int compId, MAV_CMD command, MAV_FRAME frame, float param1, float param2, float param3,
