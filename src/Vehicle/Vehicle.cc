...
void Vehicle::sendJoystickAuxRcOverrideThreadSafe(const std::array<uint16_t, 6> &channelValues, const std::array<bool, 6> &channelEnabled, bool useRcOverride)
{
    ...
    mavlink_msg_rc_channels_override_pack_chan(
        ...
        UINT16_MAX,
        UINT16_MAX,
        channelEnabled[0] ? channelValues[0] : static_cast<uint16_t>(UINT16_MAX),
        channelEnabled[1] ? channelValues[1] : static_cast<uint16_t>(UINT16_MAX),
        channelEnabled[2] ? channelValues[2] : static_cast<uint16_t>(UINT16_MAX),
        channelEnabled[3] ? channelValues[3] : static_cast<uint16_t>(UINT16_MAX),
        channelEnabled[4] ? channelValues[4] : static_cast<uint16_t>(UINT16_MAX),
        channelEnabled[5] ? channelValues[5] : static_cast<uint16_t>(UINT16_MAX),
        0,
        0,
        0,
        0,
