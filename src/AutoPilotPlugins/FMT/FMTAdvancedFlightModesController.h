...
#ifndef FMTAdvancedFlightModesController_H
#define FMTAdvancedFlightModesController_H
...
class FMTAdvancedFlightModesController : public FactPanelController
{
    Q_OBJECT
    
public:
    FMTAdvancedFlightModesController(void);
