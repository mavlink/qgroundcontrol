...
FMTSimpleFlightModesController::FMTSimpleFlightModesController(void)
    : _activeFlightMode(0)
...

{
    ...
    connect(_vehicle, &Vehicle::rcChannelsChanged, this, &FMTSimpleFlightModesController::_rcChannelsChanged);
}

/// Connected to Vehicle::rcChannelsChanged signal
void FMTSimpleFlightModesController::_rcChannelsChanged(int channelCount, int pwmValues[Vehicle::cMaxRcChannels])
{
