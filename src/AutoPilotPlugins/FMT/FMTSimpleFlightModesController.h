...
#ifndef FMTSimpleFlightModesController_H
#define FMTSimpleFlightModesController_H
...
/// MVC Controller for FMTSimpleFlightModes.qml
class FMTSimpleFlightModesController : public FactPanelController
{
    Q_OBJECT
    
public:
    FMTSimpleFlightModesController(void);
