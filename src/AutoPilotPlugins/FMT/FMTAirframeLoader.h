...
#ifndef FMTAIRFRAMELOADER_H
#define FMTAIRFRAMELOADER_H
...
/// @file FMTAirframeLoader.h
///     @author Lorenz Meier <lm@qgroundcontrol.org>

Q_DECLARE_LOGGING_CATEGORY(FMTAirframeLoaderLog)

/// Collection of Parameter Facts for FMT AutoPilot

class FMTAirframeLoader : QObject
{
    Q_OBJECT

public:
    /// @param uas Uas which this set of facts is associated with
    FMTAirframeLoader(AutoPilotPlugin* autpilot,UASInterface* uas, QObject* parent = NULL);

    static void loadAirframeMetaData(void);

    /// @return Location of FMT airframe fact meta data file
