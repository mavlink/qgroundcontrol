...
/// FMT Flight Mode configuration. This control will load either the Simple or Advanced Flight Mode config
...
SetupPage {
    ...
    Component {
        ...
        Loader {
            ...
            source: _simpleMode ? "qrc:/qml/FMTSimpleFlightModes.qml" : "qrc:/qml/FMTAdvancedFlightModes.qml"
