...
private:
    ...
    static constexpr const int _updateInterval = 150;              ///< Interval for timer which updates radio channel widgets
    static constexpr const int _rcCalPWMValidMinValue =    1300;   ///< Largest valid minimum PWM Min range value
    static constexpr const int _rcCalPWMValidMaxValue =    1700;   ///< Smallest valid maximum PWM Max range value
    static constexpr const int _rcCalPWMCenterPoint = ((_rcCalPWMValidMaxValue - _rcCalPWMValidMinValue) / 2.0f) + _rcCalPWMValidMinValue;
    static constexpr const int _rcCalPWMDefaultMinValue =  1000;   ///< Default value for Min if not set
    static constexpr const int _rcCalPWMDefaultMaxValue =  2000;   ///< Default value for Max if not set
    static constexpr const int _rcCalRoughCenterDelta =    50;     ///< Delta around center point which is considered to be roughly centered
    static constexpr const int _rcCalMoveDelta =           300;    ///< Amount of delta past center which is considered stick movement
    static constexpr const int _rcCalSettleDelta =         20;     ///< Amount of delta which is considered no stick movement
    static constexpr const int _rcCalMinDelta =            100;    ///< Amount of delta allowed around min value to consider channel at min

    static constexpr const int _stickDetectSettleMSecs = 500;
