...
void FlightModesComponentController::_appendStatusLog(const QString& text)
{
    Q_ASSERT(_statusLog);
...
void FlightModesComponentController::calibrateGyro(void)
{
    _beginTextLogging();
...
void FlightModesComponentController::calibrateCompass(void)
{
    _hideAllCalAreas();
    _beginTextLogging();
...
void FlightModesComponentController::calibrateAccel(void)
{
    _beginTextLogging();
...
void FlightModesComponentController::calibrateAirspeed(void)
{
    _hideAllCalAreas();
    _beginTextLogging();
...
void FlightModesComponentController::_beginTextLogging(void)
{
    UASInterface* uas = _autopilot->uas();
    Q_ASSERT(uas);
    connect(uas, &UASInterface::textMessageReceived, this, &FlightModesComponentController::_handleUASTextMessage);
}

void FlightModesComponentController::_handleUASTextMessage(int uasId, int compId, int severity, QString text)
{
...
void FlightModesComponentController::_refreshParams(void)
{
#if 0
...
bool FlightModesComponentController::fixedWing(void)
{
    UASInterface* uas = _autopilot->uas();
    Q_ASSERT(uas);
...
void FlightModesComponentController::_updateAndEmitGyroCalInProgress(bool inProgress)
{
    _gyroCalInProgress = inProgress;
    emit gyroCalInProgressChanged();
}

void FlightModesComponentController::_updateAndEmitShowGyroCalArea(bool show)
{
    _showGyroCalArea = show;
    emit showGyroCalAreaChanged();
}

void FlightModesComponentController::_updateAndEmitShowAccelCalArea(bool show)
{
    _showAccelCalArea = show;
    emit showAccelCalAreaChanged();
}

void FlightModesComponentController::_hideAllCalAreas(void)
{
