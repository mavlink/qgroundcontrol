...
SetupPage {
    ...
    Component {
        ...
        Item {
            ...
            property Fact _collisionPrevention: controller.parameterExists(-1, "CP_DIST") ? controller.getParameterFact(-1, "CP_DIST") : controller.getParameterFact(-1, "MPC_COL_PREV_D")
