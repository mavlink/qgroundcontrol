    ...
    QGCViewPanel {
        ...
        Item {
            ...
            QGCLabel {
                ...
                text:           qsTr("You've connected a %1 If you’d like to change this configuration, select the desired airframe below then click “Apply and Restart”.").arg( controller.currentVehicleName)
