...
private:
    ...
    quint64 _playbackStartTimeMSecs; ///< The time when the logfile was first played back. This is used to pace out
                                     ///< replaying the messages to fix long-term drift/skew. 0 indicates that the
                                     ///< player hasn't initiated playback of this log file.
