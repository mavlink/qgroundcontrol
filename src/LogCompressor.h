...
protected:
    ...
    bool holeFillingEnabled; ///< Enables the filling of holes in the dataset with the previous value (or NaN if none
                             ///< exists)
...
signals:
    ...
    /// This signal is connected to QGCApplication::showCriticalMessage to show critical errors which come from the
    /// thread. There is no need for clients to connect to this signal.
