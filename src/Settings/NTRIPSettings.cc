...
DECLARE_SETTINGSFACT(NTRIPSettings, correctionSource)
DECLARE_SETTINGSFACT(NTRIPSettings, correctionSourceInstance)
DECLARE_SETTINGSFACT(NTRIPSettings, injectLocalReceiver)
