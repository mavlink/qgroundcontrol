...
/// Provides access to group of settings. The group is named and has a visible property associated with which can
/// control whether the group is shows in the ui.
