...
bool VideoSettings::validateNetworkVideoUrl(const QString& value, const QStringList& allowedSchemes, QString& error)
{
    ...
    static const QStringList sensitiveQueryKeys = {
        QStringLiteral("access_token"), QStringLiteral("api_key"),       QStringLiteral("apikey"),
        QStringLiteral("auth"),         QStringLiteral("authorization"), QStringLiteral("key"),
        QStringLiteral("passwd"),       QStringLiteral("password"),      QStringLiteral("secret"),
