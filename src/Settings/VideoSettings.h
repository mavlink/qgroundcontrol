...
public:
    ...
    Q_PROPERTY(bool     networkVideoSessionSecretConfigured
                   READ networkVideoSessionSecretConfigured
                   NOTIFY networkVideoSecretChanged)
    Q_PROPERTY(bool     networkVideoCredentialFileSupported
                   READ networkVideoCredentialFileSupported
                   CONSTANT)
    Q_PROPERTY(QString  networkVideoConfigurationError
                   READ networkVideoConfigurationError
    ...
    bool networkVideoCredentialFileSupported() const;
    ...
    static constexpr const char* videoSourceHTTPMJPEG =
        QT_TRANSLATE_NOOP("VideoSettings", "HTTP MJPEG Video Stream");
