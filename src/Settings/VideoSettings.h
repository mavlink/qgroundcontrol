...
public:
    ...
    Q_PROPERTY(QString  launchStrVideoSource    READ launchStrVideoSource   CONSTANT)
    ...
    static constexpr const char* videoSourceLaunchStr         = QT_TRANSLATE_NOOP("VideoSettings", "GStreamer Pipeline");
