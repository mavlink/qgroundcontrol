...
/// Read-only projection; the store must share this object's thread and may outlive the view.
...
public:
    explicit GPSIntegrityFactGroup(GPSIntegrityStore& store, QObject* parent = nullptr);
...
private:
    ...
    quint64 _revision = 0;
    bool _availabilityNotificationPending = false;
