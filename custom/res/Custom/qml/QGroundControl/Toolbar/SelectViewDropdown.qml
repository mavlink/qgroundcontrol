    ...
    contentComponent: Component {
        GridLayout {
            ...
            ColumnLayout {
                ...
                // Sprig Aerospace about-box copy
                QGCLabel {
                    Layout.fillWidth: true
                    Layout.topMargin: ScreenTools.defaultFontPixelHeight
                    horizontalAlignment: Text.AlignHCenter
                    text: qsTr("Avicontrol is a ground-control station for autonomous aerial vehicles, built on the QGroundControl open-source project. \u00A9 2026 Sprig Aerospace.")
                    font.pointSize: ScreenTools.smallFontPointSize
                    wrapMode: QGCLabel.WordWrap
                }
            }
