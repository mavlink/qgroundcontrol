...
PreFlightCheckButton {
    ...
    manualText:             qsTr("Sprig GCS audio output enabled. System audio output enabled, too?")
    telemetryTextFailure:   qsTr("Sprig GCS audio output is disabled. Please enable it under application settings->general to hear audio warnings!")
