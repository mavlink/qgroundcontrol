...
#include "SprigAutoPilotPlugin.h"
#include "px4_custom_mode.h"
#include "Vehicle.h"

SprigFirmwarePlugin::SprigFirmwarePlugin()
{
...
AutoPilotPlugin* SprigFirmwarePlugin::autopilotPlugin(Vehicle *vehicle) const
{
    return new SprigAutoPilotPlugin(vehicle, vehicle);
}

const QVariantList& SprigFirmwarePlugin::toolIndicators(const Vehicle *vehicle)
{
...
bool SprigFirmwarePlugin::hasGimbal(Vehicle* /*vehicle*/, bool &rollSupported, bool &pitchSupported, bool &yawSupported) const
{
    rollSupported = false;
    pitchSupported = true;
    yawSupported = true;
...
void SprigFirmwarePlugin::updateAvailableFlightModes(FlightModeList &modeList)
{
