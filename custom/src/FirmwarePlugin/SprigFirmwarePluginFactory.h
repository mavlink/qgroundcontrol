...
/// type of vehicle.
class SprigFirmwarePluginFactory : public FirmwarePluginFactory
{
    Q_OBJECT

public:
    SprigFirmwarePluginFactory();
...
private:
    SprigFirmwarePlugin *_pluginInstance = nullptr;
};

extern SprigFirmwarePluginFactory SprigFirmwarePluginFactoryImp;
