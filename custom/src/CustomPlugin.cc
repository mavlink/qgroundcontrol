...
{
    // Al-Bayraq GCS Custom Color Palette
    // Background: #153247, Unselected: #4b4c4b, Accent: #a50605, Black: #000000
    if (colorName == QStringLiteral("window")) {
        colorInfo[QGCPalette::Dark][QGCPalette::ColorGroupEnabled]   = QColor("#153247");
        colorInfo[QGCPalette::Dark][QGCPalette::ColorGroupDisabled]  = QColor("#153247");
        colorInfo[QGCPalette::Light][QGCPalette::ColorGroupEnabled]  = QColor("#153247");
        colorInfo[QGCPalette::Light][QGCPalette::ColorGroupDisabled] = QColor("#153247");
    } else if (colorName == QStringLiteral("windowShade")) {
        colorInfo[QGCPalette::Dark][QGCPalette::ColorGroupEnabled]   = QColor("#4b4c4b");
        colorInfo[QGCPalette::Dark][QGCPalette::ColorGroupDisabled]  = QColor("#4b4c4b");
        colorInfo[QGCPalette::Light][QGCPalette::ColorGroupEnabled]  = QColor("#4b4c4b");
        colorInfo[QGCPalette::Light][QGCPalette::ColorGroupDisabled] = QColor("#4b4c4b");
        ...
        colorInfo[QGCPalette::Dark][QGCPalette::ColorGroupEnabled]   = QColor("#a50605");
        colorInfo[QGCPalette::Dark][QGCPalette::ColorGroupDisabled]  = QColor("#4b4c4b");
        colorInfo[QGCPalette::Light][QGCPalette::ColorGroupEnabled]  = QColor("#a50605");
        colorInfo[QGCPalette::Light][QGCPalette::ColorGroupDisabled] = QColor("#4b4c4b");
