    ...
    QGCFlickable {
        ...
        ColumnLayout {
            ...
            ConfigButton {
                ...
                property var ocMngr : vehicle ? vehicle.autopilotPlugin.onboardComputersManager : false
                id:                 vgmInfo
                visible:            ocMngr && checkForVGM(ocMngr.computersInfo)
                text:               qsTr("Onboard Computers Info")
                Layout.fillWidth:   true
                onClicked:          showPanel(this,"qrc:/Custom/qml/OnboardComputers/OnboardComputersInfo.qml")
            }
