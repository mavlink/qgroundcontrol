AndroidBuild {
    ...
    exists($${DESTDIR}/android-build/build/outputs/apk/android-build-release-signed.apk) {
        QMAKE_POST_LINK += && cp $${DESTDIR}/android-build/build/outputs/apk/android-build-release-signed.apk $${DESTDIR}/package/$${QGC_BINARY_NAME}.apk
    } else {
