...
readonly custom_options="$SRC/qgroundcontrol/cmake/CustomOptions.cmake"
...
readonly mavlink_dialect
readonly mavlink_version
readonly generated_include="$WORK/mavlink-include"
readonly fuzzer_source="$SRC/qgroundcontrol/test/Fuzz/MAVLinkParserFuzzer.cc"
readonly fuzzer_name=mavlink_parser_fuzzer
