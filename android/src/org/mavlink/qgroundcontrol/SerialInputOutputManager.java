...
public class SerialInputOutputManager implements Runnable {
    ...
    public interface Listener {
         ...
         */
        void onNewData(byte[] data, long userData);

        /**
         * Called when {@link SerialInputOutputManager#run()} aborts due to an error.
         */
        void onRunError(Exception e, long userData);
    }
    ...
    public SerialInputOutputManager(UsbSerialPort serialPort, Listener listener, long userData) {
        mSerialPort = serialPort;
        mListener = listener;
        mUserData = userData;
