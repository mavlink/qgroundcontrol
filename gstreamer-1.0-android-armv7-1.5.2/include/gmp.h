...
#define __GMP_CC "arm-linux-androideabi-gcc -fuse-ld=gold -std=gnu99"
#define __GMP_CFLAGS "-Wall -g -Os --sysroot=/home/slomo/Projects/android/android-ndk-r10d/platforms/android-9/arch-arm -I/home/slomo/Projects/android/android-ndk-r10d/platforms/android-9/arch-arm/usr/include -ffunction-sections -funwind-tables -fstack-protector -no-canonical-prefixes -fPIC -fomit-frame-pointer -fno-strict-aliasing -finline-limit=64  -mthumb -march=armv7-a -mfloat-abi=softfp -mfpu=vfpv3-d16 -DANDROID -DPIC -D__ARM_ARCH_7A__  -Wa,--noexecstack"
