...
#include <QtCore/qtconfigmacros.h> // Q_SVGWIDGETS_EXPORT
...
#  define QT_SVGWIDGETS_CONSTEXPR_INLINE_SINCE(major, minor) constexpr
...
#  define QT_SVGWIDGETS_CONSTEXPR_INLINE_SINCE(major, minor) \
