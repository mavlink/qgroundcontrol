...
#include <QtCore/qtconfigmacros.h> // Q_QUICKCONTROLS2IMPL_EXPORT
...
#  define QT_QUICKCONTROLS2IMPL_CONSTEXPR_INLINE_SINCE(major, minor) constexpr
...
#  define QT_QUICKCONTROLS2IMPL_CONSTEXPR_INLINE_SINCE(major, minor) \
