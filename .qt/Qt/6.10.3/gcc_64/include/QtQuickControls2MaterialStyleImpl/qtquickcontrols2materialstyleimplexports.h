...
#  define QT_QUICKCONTROLS2MATERIALSTYLEIMPL_CONSTEXPR_INLINE_SINCE(major, minor) constexpr
...
#  define QT_QUICKCONTROLS2MATERIALSTYLEIMPL_CONSTEXPR_INLINE_SINCE(major, minor) \
