...
#include <QtCore/qtconfigmacros.h> // Q_SVG_EXPORT
...
#  define QT_SVG_CONSTEXPR_INLINE_SINCE(major, minor) constexpr
...
#  define QT_SVG_CONSTEXPR_INLINE_SINCE(major, minor) \
