...
#include <QtCore/qtconfigmacros.h> // Q_QUICKCONTROLS2_EXPORT
...
#  define QT_QUICKCONTROLS2_CONSTEXPR_INLINE_SINCE(major, minor) constexpr
...
#  define QT_QUICKCONTROLS2_CONSTEXPR_INLINE_SINCE(major, minor) \
