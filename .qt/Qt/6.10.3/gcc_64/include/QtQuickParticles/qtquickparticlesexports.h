...
#include <QtCore/qtconfigmacros.h> // Q_QUICKPARTICLES_EXPORT
...
#  define QT_QUICKPARTICLES_CONSTEXPR_INLINE_SINCE(major, minor) constexpr
...
#  define QT_QUICKPARTICLES_CONSTEXPR_INLINE_SINCE(major, minor) \
