...
// then RTCM data is injected and routed through RTCMRouter -> RTCMMavlink.
// ---------------------------------------------------------------------------
...
void RTKEndToEndTest::testSurveyInToMavlinkPipeline()
{
    ...
    router.routeToVehicles(rtcm1);
    router.routeToVehicles(rtcm2);
...
void RTKEndToEndTest::testLargeRtcmFragmentedToDevice()
{
    ...
    router.routeToVehicles(largeRtcm);
