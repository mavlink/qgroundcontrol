...
private slots:
    ...
    // Edge cases
    void testParserZeroLengthPayload();
    void testParserMaxLengthPayload();
    void testParserPreambleInPayload();
    void testParserTruncatedMidFrame();
    void testParserWhitelistEdgeCases();
};
