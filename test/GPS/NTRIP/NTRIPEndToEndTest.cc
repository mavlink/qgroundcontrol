...
// LocalCaster -> NTRIPHttpTransport -> RTCMParser -> RTCMMavlink -> captured mavlink_gps_rtcm_data_t
// ---------------------------------------------------------------------------
...
void NTRIPEndToEndTest::testRtcmThroughFullPipeline()
{
    ...
    // 4. Create transport and wire it directly to mavlink
    ...
    connect(&transport, &NTRIPTransport::RTCMDataUpdate, &mavlink, &RTCMMavlink::RTCMDataUpdate);
...
UT_REGISTER_TEST(NTRIPEndToEndTest, TestLabel::Integration)
