...
void NTRIPManagerTest::testMakeGGAFormat()
{
    ...
    QByteArray gga = NTRIPGgaProvider::makeGGA(coord, 408.0);
...
void NTRIPManagerTest::testMakeGGAFieldCount()
{
    ...
    QByteArray gga = NTRIPGgaProvider::makeGGA(coord, 10.0);
...
void NTRIPManagerTest::testMakeGGAChecksum()
{
    ...
    QByteArray gga = NTRIPGgaProvider::makeGGA(coord, 16.0);
...
void NTRIPManagerTest::testMakeGGASouthWest()
{
    ...
    QByteArray gga = NTRIPGgaProvider::makeGGA(coord, 58.0);
...
void NTRIPManagerTest::testMakeGGAEquator()
{
    ...
    QByteArray gga = NTRIPGgaProvider::makeGGA(coord, 0.0);
...
void NTRIPManagerTest::testMakeGGADateLine()
{
    ...
    QByteArray ggaEast = NTRIPGgaProvider::makeGGA(coordEast, 5.0);
    ...
    QByteArray ggaWest = NTRIPGgaProvider::makeGGA(coordWest, 5.0);
...
void NTRIPManagerTest::testMakeGGAHighAltitude()
{
    ...
    QByteArray gga = NTRIPGgaProvider::makeGGA(coord, 8848.9);
...
void NTRIPManagerTest::testMakeGGANegativeAltitude()
{
    ...
    QByteArray gga = NTRIPGgaProvider::makeGGA(coord, -430.5);
...
void NTRIPManagerTest::testMakeGGADMMPrecision()
{
    ...
    QGeoCoordinate coord(47.3977, 8.5456);
    QByteArray gga = NTRIPGgaProvider::makeGGA(coord, 100.0);
