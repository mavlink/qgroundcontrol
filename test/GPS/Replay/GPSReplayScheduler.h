...
class GPSReplayScheduler final : public GPSRuntimeScheduler
{
    Q_OBJECT
public:
    explicit GPSReplayScheduler(QObject* parent = nullptr, quint64 initialUs = 1000000);
    ~GPSReplayScheduler() override;
