...
/// UI test for the experimental GeoView top-level view (preview feature).
///
...
/// switches to the GeoView main panel, and that camera gestures (pan, orbit,
/// wheel zoom, pinch zoom, two-finger twist) drive the camera correctly.
class GeoViewUITest : public QmlUITestBase
{
    Q_OBJECT
