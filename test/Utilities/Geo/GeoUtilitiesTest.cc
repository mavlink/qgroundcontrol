...
void GeoUtilitiesTest::_testValidatePolylineListCoordinates()
{
    QString errorString;

    QList<QList<QGeoCoordinate>> validPolylines;
    QList<QGeoCoordinate> polyline1;
    polyline1.append(QGeoCoordinate(47.0, -122.0));
    polyline1.append(QGeoCoordinate(48.0, -121.0));
    validPolylines.append(polyline1);

    QList<QGeoCoordinate> polyline2;
    polyline2.append(QGeoCoordinate(46.0, -120.0));
    polyline2.append(QGeoCoordinate(45.0, -119.0));
    validPolylines.append(polyline2);
    QVERIFY(GeoUtilities::validatePolylineListCoordinates(validPolylines, errorString));
    QVERIFY(errorString.isEmpty());

    QList<QList<QGeoCoordinate>> invalidPolylines = validPolylines;
    invalidPolylines[1][0] = QGeoCoordinate(95.0, -120.0); // Invalid latitude
    QVERIFY(!GeoUtilities::validatePolylineListCoordinates(invalidPolylines, errorString));
    QVERIFY(errorString.contains("Polyline 2"));
}
...
UT_REGISTER_TEST(GeoUtilitiesTest, TestLabel::Unit, TestLabel::Utilities)
