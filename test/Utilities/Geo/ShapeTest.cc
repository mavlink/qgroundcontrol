...
void ShapeTest::_testSaveInvalidCoordinates()
{
    ...
    QVERIFY(!result.success);
    QVERIFY(!result.errorString.isEmpty());
    qDebug() << "Invalid longitude rejected with:" << result.errorString;
}
