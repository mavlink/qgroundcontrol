...
{
    _mockJoystick = std::unique_ptr<MockJoystick>(MockJoystick::create(QStringLiteral("Test Controller"), 6, 16, 1));
...
{
    _mockJoystick =
        std::unique_ptr<MockJoystick>(MockJoystick::create(QStringLiteral("Identity Test Controller"), 6, 16, 1));
    QVERIFY(_mockJoystick->isValid());
    _pumpEvents();
    _discoveredJoysticks = JoystickSDL::discover();
    JoystickSDL* js = _findJoystickByInstanceId(_mockJoystick->instanceId());
...
{
    _mockJoystick = std::unique_ptr<MockJoystick>(MockJoystick::create(QStringLiteral("Capabilities Test"), 6, 16, 2));
    QVERIFY(_mockJoystick->isValid());
    _pumpEvents();
    _discoveredJoysticks = JoystickSDL::discover();
    JoystickSDL* js = _findJoystickByInstanceId(_mockJoystick->instanceId());
...
{
    _mockJoystick = std::unique_ptr<MockJoystick>(MockJoystick::create(QStringLiteral("Axis Read Test"), 6, 16, 1));
    QVERIFY(_mockJoystick->isValid());
    _pumpEvents();
    _discoveredJoysticks = JoystickSDL::discover();
    JoystickSDL* js = _findJoystickByInstanceId(_mockJoystick->instanceId());
...
{
    _mockJoystick = std::unique_ptr<MockJoystick>(MockJoystick::create(QStringLiteral("Axis Range Test"), 6, 16, 1));
    QVERIFY(_mockJoystick->isValid());
...
{
    _mockJoystick = std::unique_ptr<MockJoystick>(MockJoystick::create(QStringLiteral("Button Read Test"), 4, 16, 1));
    QVERIFY(_mockJoystick->isValid());
    _pumpEvents();
    _discoveredJoysticks = JoystickSDL::discover();
    JoystickSDL* js = _findJoystickByInstanceId(_mockJoystick->instanceId());
...
{
    _mockJoystick =
        std::unique_ptr<MockJoystick>(MockJoystick::create(QStringLiteral("Button Sequence Test"), 4, 16, 1));
    QVERIFY(_mockJoystick->isValid());
    _pumpEvents();
    _discoveredJoysticks = JoystickSDL::discover();
    JoystickSDL* js = _findJoystickByInstanceId(_mockJoystick->instanceId());
...
{
    _mockJoystick = std::unique_ptr<MockJoystick>(MockJoystick::create(QStringLiteral("Hat Direction Test"), 4, 12, 2));
    QVERIFY(_mockJoystick->isValid());
    _pumpEvents();
    _discoveredJoysticks = JoystickSDL::discover();
    JoystickSDL* js = _findJoystickByInstanceId(_mockJoystick->instanceId());
    ...
    const Joystick::HatDirection directions[] = {Joystick::HatUp,     Joystick::HatRight,    Joystick::HatDown,
                                                 Joystick::HatLeft,   Joystick::HatRightUp,  Joystick::HatRightDown,
                                                 Joystick::HatLeftUp, Joystick::HatLeftDown, Joystick::HatCentered};
...
{
    _mockJoystick = std::unique_ptr<MockJoystick>(MockJoystick::create(QStringLiteral("Polling Test"), 6, 16, 1));
    QVERIFY(_mockJoystick->isValid());
    _pumpEvents();
    _discoveredJoysticks = JoystickSDL::discover();
    JoystickSDL* js = _findJoystickByInstanceId(_mockJoystick->instanceId());
...
{
    _mockJoystick = std::unique_ptr<MockJoystick>(MockJoystick::create(QStringLiteral("Calibration Test"), 6, 16, 1));
    QVERIFY(_mockJoystick->isValid());
    _pumpEvents();
    _discoveredJoysticks = JoystickSDL::discover();
    JoystickSDL* js = _findJoystickByInstanceId(_mockJoystick->instanceId());
...
{
    _mockJoystick = std::unique_ptr<MockJoystick>(MockJoystick::create(QStringLiteral("Adjust Range Test"), 6, 16, 1));
    QVERIFY(_mockJoystick->isValid());
    _pumpEvents();
    _discoveredJoysticks = JoystickSDL::discover();
    JoystickSDL* js = _findJoystickByInstanceId(_mockJoystick->instanceId());
...
{
    _mockJoystick = std::unique_ptr<MockJoystick>(MockJoystick::create(QStringLiteral("Invalid Axis Test"), 4, 8, 1));
    QVERIFY(_mockJoystick->isValid());
    _pumpEvents();
    _discoveredJoysticks = JoystickSDL::discover();
    JoystickSDL* js = _findJoystickByInstanceId(_mockJoystick->instanceId());
...
{
    _mockJoystick = std::unique_ptr<MockJoystick>(MockJoystick::create(QStringLiteral("Invalid Button Test"), 4, 8, 0));
    QVERIFY(_mockJoystick->isValid());
    _pumpEvents();
    _discoveredJoysticks = JoystickSDL::discover();
    JoystickSDL* js = _findJoystickByInstanceId(_mockJoystick->instanceId());
...
void JoystickTest::_zeroCapabilityJoystickTest()
{
    ...
    auto minimalMock = std::unique_ptr<MockJoystick>(MockJoystick::create(QStringLiteral("Minimal Joystick"), 1, 1, 0));
...
{
    _mockJoystick = std::unique_ptr<MockJoystick>(MockJoystick::create(QStringLiteral("Disconnect Test"), 4, 8, 1));
    QVERIFY(_mockJoystick->isValid());
...
void JoystickTest::_hatButtonMappingTest()
{
    ...
    _mockJoystick = std::unique_ptr<MockJoystick>(MockJoystick::create(QStringLiteral("Hat Button Test"), 4, 8, 2));
    QVERIFY(_mockJoystick->isValid());
    _pumpEvents();
    _discoveredJoysticks = JoystickSDL::discover();
    JoystickSDL* js = _findJoystickByInstanceId(_mockJoystick->instanceId());
...
void JoystickTest::_hatMutualExclusionTest()
{
    ...
    constexpr int HatIdxRight = 3;
    _mockJoystick =
        std::unique_ptr<MockJoystick>(MockJoystick::create(QStringLiteral("Hat Mutual Exclusion Test"), 4, 8, 2));
    QVERIFY(_mockJoystick->isValid());
    _pumpEvents();
    _discoveredJoysticks = JoystickSDL::discover();
    JoystickSDL* js = _findJoystickByInstanceId(_mockJoystick->instanceId());
...
{
    _mockJoystick = std::unique_ptr<MockJoystick>(MockJoystick::create(QStringLiteral("Button Action Test"), 4, 16, 1));
    QVERIFY(_mockJoystick->isValid());
    _pumpEvents();
    _discoveredJoysticks = JoystickSDL::discover();
    JoystickSDL* js = _findJoystickByInstanceId(_mockJoystick->instanceId());
...
//-----------------------------------------------------------------------------
void JoystickTest::_connectionStateTest()
{
    _mockJoystick =
        std::unique_ptr<MockJoystick>(MockJoystick::create(QStringLiteral("Connection State Test"), 6, 16, 1));
    QVERIFY(_mockJoystick->isValid());
    _pumpEvents();
    _discoveredJoysticks = JoystickSDL::discover();
    JoystickSDL* js = _findJoystickByInstanceId(_mockJoystick->instanceId());
    QVERIFY(js != nullptr);
    // Query connection state using SDLJoystick utility
    QString connectionState = SDLJoystick::getConnectionStateForInstanceId(_mockJoystick->instanceId());
    QVERIFY2(!connectionState.isEmpty(), "Connection state should be a non-empty string");
    // Virtual joysticks typically report as "Unknown" connection state
...
// Player Index Tests
//-----------------------------------------------------------------------------
void JoystickTest::_playerIndexTest()
{
    _mockJoystick = std::unique_ptr<MockJoystick>(MockJoystick::create(QStringLiteral("Player Index Test"), 6, 16, 1));
    QVERIFY(_mockJoystick->isValid());
    _pumpEvents();
    _discoveredJoysticks = JoystickSDL::discover();
    JoystickSDL* js = _findJoystickByInstanceId(_mockJoystick->instanceId());
...
//-----------------------------------------------------------------------------
void JoystickTest::_gamepadBindingQueryTest()
{
    _mockJoystick = std::unique_ptr<MockJoystick>(MockJoystick::create(QStringLiteral("Binding Query Test"), 6, 16, 1));
    QVERIFY(_mockJoystick->isValid());
    _pumpEvents();
    _discoveredJoysticks = JoystickSDL::discover();
    JoystickSDL* js = _findJoystickByInstanceId(_mockJoystick->instanceId());
    ...
    int version = SDLJoystick::getProductVersionForInstanceId(_mockJoystick->instanceId());
