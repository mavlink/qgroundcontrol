...
UT_REGISTER_TEST(MockJoystickTest)

MockJoystickTest::MockJoystickTest() = default;
...
void MockJoystickTest::_createWithCustomCountsTest()
{
    // Test custom counts
    _mockJoystick = std::unique_ptr<MockJoystick>(MockJoystick::create(
        QStringLiteral("Custom Controller"), 8, 24, 2, 1, 1));
    QVERIFY(_mockJoystick != nullptr);
    QVERIFY(_mockJoystick->isValid());
...
{
    _mockJoystick = std::unique_ptr<MockJoystick>(MockJoystick::create(
        QStringLiteral("Axis Tracking Test"), 6, 16, 1));
    QVERIFY(_mockJoystick->isValid());
...
{
    _mockJoystick = std::unique_ptr<MockJoystick>(MockJoystick::create(
        QStringLiteral("Stick Methods Test"), 6, 16, 1));
    QVERIFY(_mockJoystick->isValid());
...
{
    _mockJoystick = std::unique_ptr<MockJoystick>(MockJoystick::create(
        QStringLiteral("Trigger Methods Test"), 6, 16, 1));
    QVERIFY(_mockJoystick->isValid());
...
{
    _mockJoystick = std::unique_ptr<MockJoystick>(MockJoystick::create(
        QStringLiteral("Button Tracking Test"), 6, 16, 1));
    QVERIFY(_mockJoystick->isValid());
...
{
    _mockJoystick = std::unique_ptr<MockJoystick>(MockJoystick::create(
        QStringLiteral("Gamepad Button Test"), 6, 16, 1));
    QVERIFY(_mockJoystick->isValid());
...
{
    _mockJoystick = std::unique_ptr<MockJoystick>(MockJoystick::create(
        QStringLiteral("Multi Button Test"), 6, 16, 1));
    QVERIFY(_mockJoystick->isValid());
...
{
    _mockJoystick = std::unique_ptr<MockJoystick>(MockJoystick::create(
        QStringLiteral("Hat Tracking Test"), 6, 16, 2));
    QVERIFY(_mockJoystick->isValid());
...
{
    _mockJoystick = std::unique_ptr<MockJoystick>(MockJoystick::create(
        QStringLiteral("DPad Convenience Test"), 6, 16, 1));
    QVERIFY(_mockJoystick->isValid());
...
{
    _mockJoystick = std::unique_ptr<MockJoystick>(MockJoystick::create(
        QStringLiteral("Button Tap Test"), 6, 16, 1));
    QVERIFY(_mockJoystick->isValid());
...
{
    _mockJoystick = std::unique_ptr<MockJoystick>(MockJoystick::create(
        QStringLiteral("Stick Deflection Test"), 6, 16, 1));
    QVERIFY(_mockJoystick->isValid());
...
{
    _mockJoystick = std::unique_ptr<MockJoystick>(MockJoystick::create(
        QStringLiteral("Trigger Pull Test"), 6, 16, 1));
    QVERIFY(_mockJoystick->isValid());
...
{
    _mockJoystick = std::unique_ptr<MockJoystick>(MockJoystick::create(
        QStringLiteral("DPad Tap Test"), 6, 16, 1));
    QVERIFY(_mockJoystick->isValid());
...
{
    _mockJoystick = std::unique_ptr<MockJoystick>(MockJoystick::create(
        QStringLiteral("Simultaneous Axes Test"), 6, 16, 1));
    QVERIFY(_mockJoystick->isValid());

    // Set multiple axes at once
    QVector<QPair<int, int>> axisValues = {
        {0, 10000},
        {1, -5000},
        {2, 20000},
        {3, -15000}
...
{
    _mockJoystick = std::unique_ptr<MockJoystick>(MockJoystick::create(
        QStringLiteral("Reset Test"), 6, 16, 2));
    QVERIFY(_mockJoystick->isValid());
