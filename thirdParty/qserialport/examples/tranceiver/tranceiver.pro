...
MOC_DIR = $$QSERIALPORT_BUILDDIR/GeneratedFiles/tranceiver

CONFIG(debug, debug|release) {
  OBJECTS_DIR = $$QSERIALPORT_BUILDDIR/Debug/tranceiver
  macx:TARGET = $$member(TARGET, 0)_debug
  windows:TARGET = $$member(TARGET, 0)d
  unix:!macx:TARGET = $$member(TARGET, 0).debug
}
else {
  OBJECTS_DIR = $$QSERIALPORT_BUILDDIR/Release/tranceiver
}
