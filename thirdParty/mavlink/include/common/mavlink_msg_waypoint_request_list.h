...
#define MAVLINK_MSG_ID_WAYPOINT_REQUEST_LIST_KEY 0x22
#define MAVLINK_MSG_43_KEY 0x22
...
static inline void mavlink_msg_waypoint_request_list_send(mavlink_channel_t chan, uint8_t target_system, uint8_t target_component)
{
	...
	MAVLINK_BUFFER_CHECK_START( chan, MAVLINK_MSG_ID_WAYPOINT_REQUEST_LIST_LEN )
