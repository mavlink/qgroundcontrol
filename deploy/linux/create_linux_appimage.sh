...
cd ${TMPDIR}
wget -c --quiet http://ftp.us.debian.org/debian/pool/main/libs/libsdl2/libsdl2-2.0-0_2.0.9+dfsg1-1_amd64.deb

cd ${APPDIR}
find ../ -name *.deb -exec dpkg -x {} . \;

# copy libdirectfb-1.7.so.7
cd ${TMPDIR}
wget -c --quiet http://ftp.us.debian.org/debian/pool/main/d/directfb/libdirectfb-1.7-7_1.7.7-9_amd64.deb
mkdir libdirectfb
dpkg -x libdirectfb-1.7-7_1.7.7-9_amd64.deb libdirectfb
...
# Go out of AppImage
cd ${TMPDIR}
wget -c --quiet "https://github.com/AppImage/AppImageKit/releases/download/continuous/appimagetool-x86_64.AppImage"
