...
#   - deploy/docker/install_sysroot_aarch64.py                 (multiarch :arm64 sysroot)
#
...
set(QGC_AARCH64_SYSROOT
    "${QGC_AARCH64_SYSROOT}"
    CACHE PATH "aarch64 sysroot for cross-build"
)

if(NOT IS_DIRECTORY "${QGC_AARCH64_SYSROOT}")
    message(FATAL_ERROR "QGC_AARCH64_SYSROOT='${QGC_AARCH64_SYSROOT}' is not a directory. "
                        "Run python3 deploy/docker/install_sysroot_aarch64.py or set -DQGC_AARCH64_SYSROOT=<path>."
    )
endif()
...
if(_qgc_cross_pkgconfig)
    set(PKG_CONFIG_EXECUTABLE
        "${_qgc_cross_pkgconfig}"
        CACHE FILEPATH "Cross pkg-config" FORCE
    )
endif()
