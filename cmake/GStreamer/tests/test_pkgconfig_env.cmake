# Test: gstreamer_apply_pkgconfig_env (SDK / SYSTEM_AUGMENT modes,
# PKG_CONFIG_EXE forwarding, DONT_DEFINE_PREFIX flag plumbing).
...
# Pick the platform separator the function will use.
...
# ── SDK mode: clears PATH, sets LIBDIR ──────────────────────────────────────
...
# ── SDK mode: PKG_CONFIG_EXE forwards to env + cache ────────────────────────
set(ENV{PKG_CONFIG} "")
...
# ── SYSTEM_AUGMENT mode: prepend to existing PATH ───────────────────────────
set(ENV{PKG_CONFIG_PATH} "/system/lib/pkgconfig")
set(ENV{PKG_CONFIG_LIBDIR} "")
gstreamer_apply_pkgconfig_env(
    MODE SYSTEM_AUGMENT
...
# ── SYSTEM_AUGMENT mode: empty PATH ─ no leading separator ──────────────────
...
# ── DONT_DEFINE_PREFIX: appended once, idempotent ───────────────────────────
...
# Reset env so a parent ctest run isn't polluted.
set(ENV{PKG_CONFIG_PATH} "")
set(ENV{PKG_CONFIG_LIBDIR} "")
set(ENV{PKG_CONFIG} "")
