...
# Qt
set(QT_MINIMUM_VERSION "6.8.1" CACHE STRING "Minimum Supported Qt Version")
set(QT_MAXIMUM_VERSION "6.8.1" CACHE STRING "Maximum Supported Qt Version")
...
option(QT_ANDROID_GENERATE_JAVA_QTQUICKVIEW_CONTENTS "Generate Java QuickView Contents" OFF)
...
set(QGC_APP_VERSION "v1.0" CACHE STRING "App Version")
set(QGC_APP_DATE "2025-1-1" CACHE STRING "App Build Date")
set(QGC_SETTINGS_VERSION "9" CACHE STRING "Settings Version - Increment to clear settings (Required after incompatible settings change)")

# Build
option(QGC_STABLE_BUILD "Stable Build" OFF)
option(QGC_DOWNLOAD_DEPENDENCIES "Download Dependency Binaries if Possible" OFF)
option(QGC_BUILD_DEPENDENCIES "Force Building of Dependencies" OFF)
