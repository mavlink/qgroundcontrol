...
set(APPDIR_PATH "${CMAKE_BINARY_DIR}/staging/$<CONFIG>/AppDir")
set(APPIMAGE_PATH "${CMAKE_BINARY_DIR}/staging/$<CONFIG>/${CMAKE_PROJECT_NAME}-${CMAKE_SYSTEM_PROCESSOR}.AppImage")
...
execute_process(
    COMMAND "${LINUXDEPLOY_PATH}"
            ...
            --custom-apprun "${CMAKE_BINARY_DIR}/staging/$<CONFIG>/AppRun"
