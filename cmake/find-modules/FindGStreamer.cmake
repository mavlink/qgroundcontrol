...
################################################################################
    ...
    if(GStreamer_USE_STATIC_LIBS)
        ...
        if("opengl" IN_LIST GSTREAMER_PLUGINS)
            find_library(GRAPHENE_LIBRARY NAMES graphene-1.0 PATHS ${GSTREAMER_LIB_PATH})
            find_library(PNG_LIBRARY NAMES png16 png PATHS ${GSTREAMER_LIB_PATH})
            find_library(JPEG_LIBRARY NAMES jpeg PATHS ${GSTREAMER_LIB_PATH})
            find_library(GST_CONTROLLER_LIBRARY NAMES gstcontroller-1.0 PATHS ${GSTREAMER_LIB_PATH})
            if(GRAPHENE_LIBRARY)
            ...
            if(GST_CONTROLLER_LIBRARY)
                target_link_libraries(GStreamer::Plugins INTERFACE ${GST_CONTROLLER_LIBRARY})
            endif()
        endif()
