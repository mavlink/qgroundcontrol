...
if (NOT GStreamer_ROOT_DIR)
    message(FATAL_ERROR "GStreamer_ROOT_DIR must be set before including FindGStreamer")
endif()
...
elseif(PC_GStreamer_gstreamer-1.0_VERSION)
    # When multiple modules are passed to pkg_check_modules, the combined
    # VERSION variable is empty.  Fall back to the per-module version.
    set(GStreamer_VERSION "${PC_GStreamer_gstreamer-1.0_VERSION}")
endif()
