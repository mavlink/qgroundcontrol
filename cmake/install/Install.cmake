...
set(QGC_APPIMAGE_UPDATE_INFORMATION
    ""
    CACHE STRING "AppImage update information passed to appimagetool; empty disables delta-update metadata"
)
...
# CPackDeb's dpkg-shlibdeps. The default Runtime component makes this run for
# native package staging while excluding the separate AppImage component.
if(LINUX)
    install(
        CODE [[
...
elseif(LINUX)
    ...
    install(
        ...
        set(QGC_APPIMAGE_UPDATE_INFORMATION \"${QGC_APPIMAGE_UPDATE_INFORMATION}\")
...
if(NOT QGC_CPACK_GENERATOR STREQUAL "" AND NOT QGC_CPACK_GENERATOR IN_LIST _qgc_platform_cpack_generators)
    message(FATAL_ERROR "QGC: QGC_CPACK_GENERATOR='${QGC_CPACK_GENERATOR}' is unavailable on ${CMAKE_SYSTEM_NAME}. "
...
elseif(NOT QGC_CPACK_GENERATOR STREQUAL "")
    message(FATAL_ERROR "QGC: unsupported QGC_CPACK_GENERATOR='${QGC_CPACK_GENERATOR}'. "
...
elseif(
    ...
    AND NOT ANDROID
    AND NOT IOS
    AND QGC_LINUX_DISTRO_FAMILY STREQUAL "arch"
)
